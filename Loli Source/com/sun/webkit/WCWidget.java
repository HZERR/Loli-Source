...
class WCWidget {
    ...
    protected void setCursor(long l2) {
    }
    ...
    private void fwkSetBounds(int n2, int n3, int n4, int n5) {
        if (log.isLoggable(Level.FINER)) {
            log.log(Level.FINER, "setBounds({0}, {1}, {2}, {3})", new Object[]{n2, n3, n4, n5});
        }
    ...
    private void fwkSetCursor(long l2) {
        if (log.isLoggable(Level.FINER)) {
            log.log(Level.FINER, "setCursor({0})", l2);
        }
        this.setCursor(l2);
    }
