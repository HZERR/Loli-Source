...
public final class PerfLogger {
    ...
    private final Comparator timeComparator = (object, object2) -> {
        long l2;
        long l3 = this.probes.get((String)object).totalTime;
        if (l3 > (l2 = this.probes.get((String)object2).totalTime)) {
            return 1;
        }
        if (l3 < l2) {
            return -1;
    ...
    private final Comparator countComparator = (object, object2) -> {
        long l2;
        long l3 = this.probes.get((String)object).count;
        if (l3 > (l2 = (long)this.probes.get((String)object2).count)) {
            return 1;
        }
        if (l3 < l2) {
            return -1;
