...
public abstract class WCGraphicsManager {
    ...
    private void fwkLoadFromResource(String string, long l2) {
        ...
        try {
            ...
            while ((n2 = inputStream.read(arrby)) > -1) {
                WCGraphicsManager.append(l2, arrby, n2);
            }
            inputStream.close();
        }
        catch (IOException iOException) {
    ...
    private WCMediaPlayer fwkCreateMediaPlayer(long l2) {
        WCMediaPlayer wCMediaPlayer = this.createMediaPlayer();
        wCMediaPlayer.setNativePointer(l2);
    ...
    synchronized Ref getRef(int n2) {
        return this.refMap.get(n2);
    }
