...
public final class BackForwardList {
    ...
    BackForwardList(WebPage webPage) {
        ...
        webPage.addLoadListenerClient(new LoadListenerClient(){
            ...
            public void dispatchLoadEvent(long l2, int n2, String string, String string2, double d2, int n3) {
                Entry entry;
                if (n2 == 14 && (entry = BackForwardList.this.getCurrentEntry()) != null) {
    ...
    public void setMaximumSize(int n2) {
        BackForwardList.bflSetMaximumSize(this.page.getPage(), n2);
    }
    ...
    public Entry get(int n2) {
        Entry entry = (Entry)BackForwardList.bflGet(this.page.getPage(), n2);
        return entry;
    }
    ...
    public Entry[] toArray() {
        int n2 = this.size();
        Entry[] arrentry = new Entry[n2];
        for (int i2 = 0; i2 < n2; ++i2) {
            arrentry[i2] = this.get(i2);
        }
        return arrentry;
    }

    public void setCurrentIndex(int n2) {
        if (BackForwardList.bflSetCurrentIndex(this.page.getPage(), n2) < 0) {
            throw new IllegalArgumentException("invalid index: " + n2);
        }
    }

    private boolean canGoBack(int n2) {
        return n2 > 0;
    }
    ...
    public boolean goBack() {
        ...
        if (this.canGoBack(n2)) {
            this.setCurrentIndex(n2 - 1);
            return true;
        }
        return false;
    }

    private boolean canGoForward(int n2) {
