...
public abstract class PopupMenu {
    ...
    protected void notifySelectionCommited(int n2) {
        this.twkSelectionCommited(this.pdata, n2);
    }
    ...
    private static PopupMenu fwkCreatePopupMenu(long l2) {
        PopupMenu popupMenu = Utilities.getUtilities().createPopupMenu();
        popupMenu.pdata = l2;
        return popupMenu;
    }

    private void fwkShow(WebPage webPage, int n2, int n3, int n4) {
        assert (webPage != null);
        this.show(webPage, n2, n3, n4);
    }
    ...
    private void fwkSetSelectedItem(int n2) {
        this.setSelectedItem(n2);
    }

    private void fwkAppendItem(String string, boolean bl, boolean bl2, boolean bl3, int n2, int n3, WCFont wCFont) {
        this.appendItem(string, bl, bl2, bl3, n2, n3, wCFont);
    }
