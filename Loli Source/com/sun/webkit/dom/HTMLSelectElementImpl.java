...
implements HTMLSelectElement {
    HTMLSelectElementImpl(long l2) {
        super(l2);
    }

    static HTMLSelectElement getImpl(long l2) {
        return (HTMLSelectElement)HTMLSelectElementImpl.create(l2);
    }
    ...
    public void setSize(int n2) {
        HTMLSelectElementImpl.setSizeImpl(this.getPeer(), n2);
    }
    ...
    public void setLength(int n2) throws DOMException {
        HTMLSelectElementImpl.setLengthImpl(this.getPeer(), n2);
    }
    ...
    public void setSelectedIndex(int n2) {
        HTMLSelectElementImpl.setSelectedIndexImpl(this.getPeer(), n2);
    }
    ...
    public String getAutocomplete() {
        return HTMLSelectElementImpl.getAutocompleteImpl(this.getPeer());
    }

    static native String getAutocompleteImpl(long var0);

    public void setAutocomplete(String string) {
        HTMLSelectElementImpl.setAutocompleteImpl(this.getPeer(), string);
    }

    static native void setAutocompleteImpl(long var0, String var2);

    public HTMLOptionElement item(int n2) {
        return HTMLOptionElementImpl.getImpl(HTMLSelectElementImpl.itemImpl(this.getPeer(), n2));
    }

    static native long itemImpl(long var0, int var2);

    public HTMLOptionElement namedItem(String string) {
        return HTMLOptionElementImpl.getImpl(HTMLSelectElementImpl.namedItemImpl(this.getPeer(), string));
    }
    ...
    public void remove(int n2) {
        HTMLSelectElementImpl.removeImpl(this.getPeer(), n2);
    }
