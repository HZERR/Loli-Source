...
implements MutationEvent {
    ...
    MutationEventImpl(long l2) {
        super(l2);
    }

    static MutationEvent getImpl(long l2) {
        return (MutationEvent)MutationEventImpl.create(l2);
    }
    ...
    public void initMutationEvent(String string, boolean bl, boolean bl2, Node node, String string2, String string3, String string4, short s2) {
        MutationEventImpl.initMutationEventImpl(this.getPeer(), string, bl, bl2, NodeImpl.getPeer(node), string2, string3, string4, s2);
    }
