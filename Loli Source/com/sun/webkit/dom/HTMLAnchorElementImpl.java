...
implements HTMLAnchorElement {
    HTMLAnchorElementImpl(long l2) {
        super(l2);
    }

    static HTMLAnchorElement getImpl(long l2) {
        return (HTMLAnchorElement)HTMLAnchorElementImpl.create(l2);
    }
    ...
    public void setText(String string) throws DOMException {
        HTMLAnchorElementImpl.setTextImpl(this.getPeer(), string);
    }
    ...
    public String getUsername() {
        return HTMLAnchorElementImpl.getUsernameImpl(this.getPeer());
    }

    static native String getUsernameImpl(long var0);

    public void setUsername(String string) {
        HTMLAnchorElementImpl.setUsernameImpl(this.getPeer(), string);
    }

    static native void setUsernameImpl(long var0, String var2);

    public String getPassword() {
        return HTMLAnchorElementImpl.getPasswordImpl(this.getPeer());
    }

    static native String getPasswordImpl(long var0);

    public void setPassword(String string) {
        HTMLAnchorElementImpl.setPasswordImpl(this.getPeer(), string);
    }
