...
implements HTMLTableColElement {
    HTMLTableColElementImpl(long l2) {
        super(l2);
    }

    static HTMLTableColElement getImpl(long l2) {
        return (HTMLTableColElement)HTMLTableColElementImpl.create(l2);
    }
    ...
    public void setSpan(int n2) {
        HTMLTableColElementImpl.setSpanImpl(this.getPeer(), n2);
    }
