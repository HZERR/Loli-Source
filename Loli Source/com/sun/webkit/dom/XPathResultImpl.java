...
implements XPathResult {
    ...
    XPathResultImpl(long l2) {
        this.peer = l2;
        Disposer.addRecord(this, new SelfDisposer(l2));
    }

    static XPathResult create(long l2) {
        if (l2 == 0L) {
            return null;
        }
        return new XPathResultImpl(l2);
    }
    ...
    static XPathResult getImpl(long l2) {
        return XPathResultImpl.create(l2);
    }
    ...
    @Override
    public Node snapshotItem(int n2) throws DOMException {
        return NodeImpl.getImpl(XPathResultImpl.snapshotItemImpl(this.getPeer(), n2));
    }
