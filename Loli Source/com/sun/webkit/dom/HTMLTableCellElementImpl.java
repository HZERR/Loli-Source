...
implements HTMLTableCellElement {
    HTMLTableCellElementImpl(long l2) {
        super(l2);
    }

    static HTMLTableCellElement getImpl(long l2) {
        return (HTMLTableCellElement)HTMLTableCellElementImpl.create(l2);
    }
    ...
    public void setColSpan(int n2) {
        HTMLTableCellElementImpl.setColSpanImpl(this.getPeer(), n2);
    }
    ...
    public void setRowSpan(int n2) {
        HTMLTableCellElementImpl.setRowSpanImpl(this.getPeer(), n2);
    }
