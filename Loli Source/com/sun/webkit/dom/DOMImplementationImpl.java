...
implements DOMImplementation {
    ...
    DOMImplementationImpl(long l2) {
        this.peer = l2;
        Disposer.addRecord(this, new SelfDisposer(l2));
    }

    static DOMImplementation create(long l2) {
        if (l2 == 0L) {
            return null;
        }
        return new DOMImplementationImpl(l2);
    }
    ...
    static DOMImplementation getImpl(long l2) {
        return DOMImplementationImpl.create(l2);
    }
