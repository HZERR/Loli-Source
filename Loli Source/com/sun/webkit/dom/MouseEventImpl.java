...
implements MouseEvent {
    MouseEventImpl(long l2) {
        super(l2);
    }

    static MouseEvent getImpl(long l2) {
        return (MouseEvent)MouseEventImpl.create(l2);
    }
    ...
    public void initMouseEvent(String string, boolean bl, boolean bl2, AbstractView abstractView, int n2, int n3, int n4, int n5, int n6, boolean bl3, boolean bl4, boolean bl5, boolean bl6, short s2, EventTarget eventTarget) {
        MouseEventImpl.initMouseEventImpl(this.getPeer(), string, bl, bl2, DOMWindowImpl.getPeer(abstractView), n2, n3, n4, n5, n6, bl3, bl4, bl5, bl6, s2, NodeImpl.getPeer((NodeImpl)eventTarget));
    }
