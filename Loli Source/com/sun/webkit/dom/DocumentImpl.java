...
DocumentView,
DocumentEvent {
    DocumentImpl(long l2) {
        super(l2);
    }

    static Document getImpl(long l2) {
        return (Document)DocumentImpl.create(l2);
    }

    static native boolean isHTMLDocumentImpl(long var0);

    @Override
    public Object evaluate(String string, Node node, XPathNSResolver xPathNSResolver, short s2, Object object) throws DOMException {
        return this.evaluate(string, node, xPathNSResolver, s2, (XPathResult)object);
    }
    ...
    public String getContentType() {
        return DocumentImpl.getContentTypeImpl(this.getPeer());
    }
    ...
    public Element getActiveElement() {
        return ElementImpl.getImpl(DocumentImpl.getActiveElementImpl(this.getPeer()));
    }
    ...
    public Element getScrollingElement() {
        return ElementImpl.getImpl(DocumentImpl.getScrollingElementImpl(this.getPeer()));
    }
    ...
    public EventListener getOncanplay() {
        return EventListenerImpl.getImpl(DocumentImpl.getOncanplayImpl(this.getPeer()));
    }

    static native long getOncanplayImpl(long var0);

    public void setOncanplay(EventListener eventListener) {
        DocumentImpl.setOncanplayImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }

    static native void setOncanplayImpl(long var0, long var2);

    public EventListener getOncanplaythrough() {
        return EventListenerImpl.getImpl(DocumentImpl.getOncanplaythroughImpl(this.getPeer()));
    }

    static native long getOncanplaythroughImpl(long var0);

    public void setOncanplaythrough(EventListener eventListener) {
        DocumentImpl.setOncanplaythroughImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }
    ...
    public EventListener getOnresize() {
        return EventListenerImpl.getImpl(DocumentImpl.getOnresizeImpl(this.getPeer()));
    }

    static native long getOnresizeImpl(long var0);

    public void setOnresize(EventListener eventListener) {
        DocumentImpl.setOnresizeImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }
    ...
    public EventListener getOnseeked() {
        return EventListenerImpl.getImpl(DocumentImpl.getOnseekedImpl(this.getPeer()));
    }

    static native long getOnseekedImpl(long var0);

    public void setOnseeked(EventListener eventListener) {
        DocumentImpl.setOnseekedImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }

    static native void setOnseekedImpl(long var0, long var2);

    public EventListener getOnseeking() {
        return EventListenerImpl.getImpl(DocumentImpl.getOnseekingImpl(this.getPeer()));
    }

    static native long getOnseekingImpl(long var0);

    public void setOnseeking(EventListener eventListener) {
        DocumentImpl.setOnseekingImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }
    ...
    public EventListener getOnstalled() {
        return EventListenerImpl.getImpl(DocumentImpl.getOnstalledImpl(this.getPeer()));
    }

    static native long getOnstalledImpl(long var0);

    public void setOnstalled(EventListener eventListener) {
        DocumentImpl.setOnstalledImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }
    ...
    public HTMLCollection getChildren() {
        return HTMLCollectionImpl.getImpl(DocumentImpl.getChildrenImpl(this.getPeer()));
    }

    static native long getChildrenImpl(long var0);

    public Element getFirstElementChild() {
        return ElementImpl.getImpl(DocumentImpl.getFirstElementChildImpl(this.getPeer()));
    }

    static native long getFirstElementChildImpl(long var0);

    public Element getLastElementChild() {
        return ElementImpl.getImpl(DocumentImpl.getLastElementChildImpl(this.getPeer()));
    }

    static native long getLastElementChildImpl(long var0);

    public int getChildElementCount() {
        return DocumentImpl.getChildElementCountImpl(this.getPeer());
    }
    ...
    public NodeIterator createNodeIterator(Node node, int n2, NodeFilter nodeFilter) throws DOMException {
        return NodeIteratorImpl.getImpl(DocumentImpl.createNodeIteratorImpl(this.getPeer(), NodeImpl.getPeer(node), n2, NodeFilterImpl.getPeer(nodeFilter)));
    }

    static native long createNodeIteratorImpl(long var0, long var2, int var4, long var5);

    public TreeWalker createTreeWalker(Node node, int n2, NodeFilter nodeFilter) throws DOMException {
        return TreeWalkerImpl.getImpl(DocumentImpl.createTreeWalkerImpl(this.getPeer(), NodeImpl.getPeer(node), n2, NodeFilterImpl.getPeer(nodeFilter)));
    }

    static native long createTreeWalkerImpl(long var0, long var2, int var4, long var5);
    ...
    public XPathResult evaluate(String string, Node node, XPathNSResolver xPathNSResolver, short s2, XPathResult xPathResult) throws DOMException {
        return XPathResultImpl.getImpl(DocumentImpl.evaluateImpl(this.getPeer(), string, NodeImpl.getPeer(node), XPathNSResolverImpl.getPeer(xPathNSResolver), s2, XPathResultImpl.getPeer(xPathResult)));
    }
    ...
    public Element elementFromPoint(int n2, int n3) {
        return ElementImpl.getImpl(DocumentImpl.elementFromPointImpl(this.getPeer(), n2, n3));
    }

    static native long elementFromPointImpl(long var0, int var2, int var3);

    public Range caretRangeFromPoint(int n2, int n3) {
        return RangeImpl.getImpl(DocumentImpl.caretRangeFromPointImpl(this.getPeer(), n2, n3));
    }
    ...
    public HTMLCollection getElementsByClassName(String string) {
        return HTMLCollectionImpl.getImpl(DocumentImpl.getElementsByClassNameImpl(this.getPeer(), string));
    }

    static native long getElementsByClassNameImpl(long var0, String var2);

    public boolean hasFocus() {
        return DocumentImpl.hasFocusImpl(this.getPeer());
    }
