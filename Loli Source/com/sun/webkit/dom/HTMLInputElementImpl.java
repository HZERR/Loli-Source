...
implements HTMLInputElement {
    HTMLInputElementImpl(long l2) {
        super(l2);
    }

    static HTMLInputElement getImpl(long l2) {
        return (HTMLInputElement)HTMLInputElementImpl.create(l2);
    }
    ...
    public void setHeight(int n2) {
        HTMLInputElementImpl.setHeightImpl(this.getPeer(), n2);
    }
    ...
    public void setMaxLength(int n2) throws DOMException {
        HTMLInputElementImpl.setMaxLengthImpl(this.getPeer(), n2);
    }
    ...
    public void setValueAsDate(long l2) throws DOMException {
        HTMLInputElementImpl.setValueAsDateImpl(this.getPeer(), l2);
    }
    ...
    public void setValueAsNumber(double d2) throws DOMException {
        HTMLInputElementImpl.setValueAsNumberImpl(this.getPeer(), d2);
    }
    ...
    public void setWidth(int n2) {
        HTMLInputElementImpl.setWidthImpl(this.getPeer(), n2);
    }
    ...
    public void stepUp(int n2) throws DOMException {
        HTMLInputElementImpl.stepUpImpl(this.getPeer(), n2);
    }

    static native void stepUpImpl(long var0, int var2);

    public void stepDown(int n2) throws DOMException {
        HTMLInputElementImpl.stepDownImpl(this.getPeer(), n2);
    }
    ...
    public void setRangeTextEx(String string, int n2, int n3, String string2) throws DOMException {
        HTMLInputElementImpl.setRangeTextExImpl(this.getPeer(), string, n2, n3, string2);
    }
