...
public class DOMSelectionImpl {
    ...
    DOMSelectionImpl(long l2) {
        this.peer = l2;
        Disposer.addRecord(this, new SelfDisposer(l2));
    }

    static DOMSelectionImpl create(long l2) {
        if (l2 == 0L) {
            return null;
        }
        return new DOMSelectionImpl(l2);
    }
    ...
    static DOMSelectionImpl getImpl(long l2) {
        return DOMSelectionImpl.create(l2);
    }
    ...
    public void collapse(Node node, int n2) throws DOMException {
        DOMSelectionImpl.collapseImpl(this.getPeer(), NodeImpl.getPeer(node), n2);
    }
    ...
    public void extend(Node node, int n2) throws DOMException {
        DOMSelectionImpl.extendImpl(this.getPeer(), NodeImpl.getPeer(node), n2);
    }

    static native void extendImpl(long var0, long var2, int var4);

    public Range getRangeAt(int n2) throws DOMException {
        return RangeImpl.getImpl(DOMSelectionImpl.getRangeAtImpl(this.getPeer(), n2));
    }
    ...
    public void setBaseAndExtent(Node node, int n2, Node node2, int n3) throws DOMException {
        DOMSelectionImpl.setBaseAndExtentImpl(this.getPeer(), NodeImpl.getPeer(node), n2, NodeImpl.getPeer(node2), n3);
    }

    static native void setBaseAndExtentImpl(long var0, long var2, int var4, long var5, int var7);

    public void setPosition(Node node, int n2) throws DOMException {
        DOMSelectionImpl.setPositionImpl(this.getPeer(), NodeImpl.getPeer(node), n2);
    }
