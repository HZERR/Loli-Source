...
implements HTMLTableRowElement {
    HTMLTableRowElementImpl(long l2) {
        super(l2);
    }

    static HTMLTableRowElement getImpl(long l2) {
        return (HTMLTableRowElement)HTMLTableRowElementImpl.create(l2);
    }
    ...
    @Override
    public HTMLElement insertCell(int n2) throws DOMException {
        return HTMLElementImpl.getImpl(HTMLTableRowElementImpl.insertCellImpl(this.getPeer(), n2));
    }

    static native long insertCellImpl(long var0, int var2);

    @Override
    public void deleteCell(int n2) throws DOMException {
        HTMLTableRowElementImpl.deleteCellImpl(this.getPeer(), n2);
    }
