...
implements HTMLBodyElement {
    HTMLBodyElementImpl(long l2) {
        super(l2);
    }

    static HTMLBodyElement getImpl(long l2) {
        return (HTMLBodyElement)HTMLBodyElementImpl.create(l2);
    }
    ...
    public EventListener getOnfocusin() {
        return EventListenerImpl.getImpl(HTMLBodyElementImpl.getOnfocusinImpl(this.getPeer()));
    }
    ...
    public void setOnfocusin(EventListener eventListener) {
        HTMLBodyElementImpl.setOnfocusinImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }
    ...
    public EventListener getOnfocusout() {
        return EventListenerImpl.getImpl(HTMLBodyElementImpl.getOnfocusoutImpl(this.getPeer()));
    }
    ...
    public void setOnfocusout(EventListener eventListener) {
        HTMLBodyElementImpl.setOnfocusoutImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }
    ...
    public EventListener getOnscroll() {
        return EventListenerImpl.getImpl(HTMLBodyElementImpl.getOnscrollImpl(this.getPeer()));
    }
    ...
    public void setOnscroll(EventListener eventListener) {
        HTMLBodyElementImpl.setOnscrollImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }

    static native void setOnscrollImpl(long var0, long var2);

    public EventListener getOnselectionchange() {
        return EventListenerImpl.getImpl(HTMLBodyElementImpl.getOnselectionchangeImpl(this.getPeer()));
    }

    static native long getOnselectionchangeImpl(long var0);

    public void setOnselectionchange(EventListener eventListener) {
        HTMLBodyElementImpl.setOnselectionchangeImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }
    ...
    public EventListener getOnpagehide() {
        return EventListenerImpl.getImpl(HTMLBodyElementImpl.getOnpagehideImpl(this.getPeer()));
    }

    static native long getOnpagehideImpl(long var0);

    public void setOnpagehide(EventListener eventListener) {
        HTMLBodyElementImpl.setOnpagehideImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }

    static native void setOnpagehideImpl(long var0, long var2);

    public EventListener getOnpageshow() {
        return EventListenerImpl.getImpl(HTMLBodyElementImpl.getOnpageshowImpl(this.getPeer()));
    }

    static native long getOnpageshowImpl(long var0);

    public void setOnpageshow(EventListener eventListener) {
        HTMLBodyElementImpl.setOnpageshowImpl(this.getPeer(), EventListenerImpl.getPeer(eventListener));
    }
