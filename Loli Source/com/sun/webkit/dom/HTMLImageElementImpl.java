...
implements HTMLImageElement {
    HTMLImageElementImpl(long l2) {
        super(l2);
    }

    static HTMLImageElement getImpl(long l2) {
        return (HTMLImageElement)HTMLImageElementImpl.create(l2);
    }
    ...
    public String getSizes() {
        return HTMLImageElementImpl.getSizesImpl(this.getPeer());
    }

    static native String getSizesImpl(long var0);

    public void setSizes(String string) {
        HTMLImageElementImpl.setSizesImpl(this.getPeer(), string);
    }

    static native void setSizesImpl(long var0, String var2);

    public String getCurrentSrc() {
        return HTMLImageElementImpl.getCurrentSrcImpl(this.getPeer());
    }
