...
implements HTMLOListElement {
    HTMLOListElementImpl(long l2) {
        super(l2);
    }

    static HTMLOListElement getImpl(long l2) {
        return (HTMLOListElement)HTMLOListElementImpl.create(l2);
    }
    ...
    public void setStart(int n2) {
        HTMLOListElementImpl.setStartImpl(this.getPeer(), n2);
    }
