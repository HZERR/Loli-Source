...
implements UIEvent {
    ...
    static UIEvent getImpl(long l2) {
        return (UIEvent)UIEventImpl.create(l2);
    }
    ...
    public void initUIEvent(String string, boolean bl, boolean bl2, AbstractView abstractView, int n2) {
        UIEventImpl.initUIEventImpl(this.getPeer(), string, bl, bl2, DOMWindowImpl.getPeer(abstractView), n2);
    }
