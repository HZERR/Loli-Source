...
EventTarget {
    ...
    private static AbstractView getCachedImpl(long l2) {
        SelfDisposer selfDisposer;
        if (l2 == 0L) {
            return null;
        }
        int n2 = DOMWindowImpl.hashPeer(l2);
        ...
        while (object2 != null) {
            ...
            if (((SelfDisposer)object2).peer == l2) {
                ...
                DOMWindowImpl.hashTable[n2] = selfDisposer;
                break;
            }
            object = object2;
            object2 = selfDisposer;
        }
        object2 = (DOMWindowImpl)DOMWindowImpl.createInterface(l2);
    ...
    private static void rehash() {
        ...
        while (--n3 >= 0) {
            ...
            while (selfDisposer != null) {
                ...
                int n4 = DOMWindowImpl.hashPeer(selfDisposer.peer);
    ...
    DOMWindowImpl(long l2) {
        super(l2, 2);
    }

    static AbstractView createInterface(long l2) {
        if (l2 == 0L) {
            return null;
        }
        return new DOMWindowImpl(l2);
    }

    static AbstractView create(long l2) {
        return DOMWindowImpl.getCachedImpl(l2);
    }
    ...
    static AbstractView getImpl(long l2) {
        return DOMWindowImpl.create(l2);
    }
    ...
    public void clearTimeout(int n2) {
        DOMWindowImpl.clearTimeoutImpl(this.getPeer(), n2);
    }

    static native void clearTimeoutImpl(long var0, int var2);

    public void clearInterval(int n2) {
        DOMWindowImpl.clearIntervalImpl(this.getPeer(), n2);
    }
    ...
    extends Disposer.WeakDisposerRecord {
        ...
        @Override
        public void dispose() {
            int n2 = DOMWindowImpl.hashPeer(this.peer);
