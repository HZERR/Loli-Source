...
implements HTMLTableElement {
    HTMLTableElementImpl(long l2) {
        super(l2);
    }

    static HTMLTableElement getImpl(long l2) {
        return (HTMLTableElement)HTMLTableElementImpl.create(l2);
    }
    ...
    public HTMLElement insertRow(int n2) throws DOMException {
        return HTMLElementImpl.getImpl(HTMLTableElementImpl.insertRowImpl(this.getPeer(), n2));
    }
    ...
    public void deleteRow(int n2) throws DOMException {
        HTMLTableElementImpl.deleteRowImpl(this.getPeer(), n2);
    }
