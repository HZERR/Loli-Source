...
implements HTMLTableSectionElement {
    HTMLTableSectionElementImpl(long l2) {
        super(l2);
    }

    static HTMLTableSectionElement getImpl(long l2) {
        return (HTMLTableSectionElement)HTMLTableSectionElementImpl.create(l2);
    }
    ...
    @Override
    public HTMLElement insertRow(int n2) throws DOMException {
        return HTMLElementImpl.getImpl(HTMLTableSectionElementImpl.insertRowImpl(this.getPeer(), n2));
    }

    static native long insertRowImpl(long var0, int var2);

    @Override
    public void deleteRow(int n2) throws DOMException {
        HTMLTableSectionElementImpl.deleteRowImpl(this.getPeer(), n2);
    }
