...
implements HTMLTextAreaElement {
    HTMLTextAreaElementImpl(long l2) {
        super(l2);
    }

    static HTMLTextAreaElement getImpl(long l2) {
        return (HTMLTextAreaElement)HTMLTextAreaElementImpl.create(l2);
    }
    ...
    public void setMaxLength(int n2) throws DOMException {
        HTMLTextAreaElementImpl.setMaxLengthImpl(this.getPeer(), n2);
    }
    ...
    public void setRows(int n2) {
        HTMLTextAreaElementImpl.setRowsImpl(this.getPeer(), n2);
    }
    ...
    public void setCols(int n2) {
        HTMLTextAreaElementImpl.setColsImpl(this.getPeer(), n2);
    }
    ...
    public void setSelectionStart(int n2) {
        HTMLTextAreaElementImpl.setSelectionStartImpl(this.getPeer(), n2);
    }
    ...
    public void setSelectionEnd(int n2) {
        HTMLTextAreaElementImpl.setSelectionEndImpl(this.getPeer(), n2);
    }
    ...
    public String getAutocomplete() {
        return HTMLTextAreaElementImpl.getAutocompleteImpl(this.getPeer());
    }

    static native String getAutocompleteImpl(long var0);

    public void setAutocomplete(String string) {
        HTMLTextAreaElementImpl.setAutocompleteImpl(this.getPeer(), string);
    }
    ...
    public void setRangeTextEx(String string, int n2, int n3, String string2) throws DOMException {
        HTMLTextAreaElementImpl.setRangeTextExImpl(this.getPeer(), string, n2, n3, string2);
    }

    static native void setRangeTextExImpl(long var0, String var2, int var3, int var4, String var5);

    public void setSelectionRange(int n2, int n3, String string) {
        HTMLTextAreaElementImpl.setSelectionRangeImpl(this.getPeer(), n2, n3, string);
    }
