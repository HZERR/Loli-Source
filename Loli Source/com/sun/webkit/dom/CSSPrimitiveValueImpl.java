...
implements CSSPrimitiveValue {
    ...
    CSSPrimitiveValueImpl(long l2) {
        super(l2);
    }

    static CSSPrimitiveValue getImpl(long l2) {
        return (CSSPrimitiveValue)CSSPrimitiveValueImpl.create(l2);
    }
    ...
    public void setFloatValue(short s2, float f2) throws DOMException {
        CSSPrimitiveValueImpl.setFloatValueImpl(this.getPeer(), s2, f2);
    }
    ...
    public float getFloatValue(short s2) throws DOMException {
        return CSSPrimitiveValueImpl.getFloatValueImpl(this.getPeer(), s2);
    }
    ...
    public void setStringValue(short s2, String string) throws DOMException {
        CSSPrimitiveValueImpl.setStringValueImpl(this.getPeer(), s2, string);
    }
