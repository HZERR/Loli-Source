...
implements NamedNodeMap {
    ...
    NamedNodeMapImpl(long l2) {
        this.peer = l2;
        Disposer.addRecord(this, new SelfDisposer(l2));
    }

    static NamedNodeMap create(long l2) {
        if (l2 == 0L) {
            return null;
        }
        return new NamedNodeMapImpl(l2);
    }
    ...
    static NamedNodeMap getImpl(long l2) {
        return NamedNodeMapImpl.create(l2);
    }
    ...
    public Node item(int n2) {
        return NodeImpl.getImpl(NamedNodeMapImpl.itemImpl(this.getPeer(), n2));
    }
