...
implements Event {
    ...
    static Event create(long l2) {
        if (l2 == 0L) {
            return null;
        }
        switch (EventImpl.getCPPTypeImpl(l2)) {
            case 2: {
                return new MouseEventImpl(l2);
            }
            case 3: {
                return new KeyboardEventImpl(l2);
            }
            case 1: {
                return new WheelEventImpl(l2);
            }
            case 4: {
                return new UIEventImpl(l2);
            }
            case 5: {
                return new MutationEventImpl(l2);
            }
        }
        return new EventImpl(l2);
    }
    ...
    static Event getImpl(long l2) {
        return EventImpl.create(l2);
    }
    ...
    public boolean getIsTrusted() {
        return EventImpl.getIsTrustedImpl(this.getPeer());
    }
