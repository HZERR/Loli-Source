...
extends UIEventImpl {
    ...
    KeyboardEventImpl(long l2) {
        super(l2);
    }

    static KeyboardEventImpl getImpl(long l2) {
        return (KeyboardEventImpl)KeyboardEventImpl.create(l2);
    }
    ...
    public void initKeyboardEvent(String string, boolean bl, boolean bl2, AbstractView abstractView, String string2, int n2, boolean bl3, boolean bl4, boolean bl5, boolean bl6, boolean bl7) {
        KeyboardEventImpl.initKeyboardEventImpl(this.getPeer(), string, bl, bl2, DOMWindowImpl.getPeer(abstractView), string2, n2, bl3, bl4, bl5, bl6, bl7);
    }
    ...
    public void initKeyboardEventEx(String string, boolean bl, boolean bl2, AbstractView abstractView, String string2, int n2, boolean bl3, boolean bl4, boolean bl5, boolean bl6) {
        KeyboardEventImpl.initKeyboardEventExImpl(this.getPeer(), string, bl, bl2, DOMWindowImpl.getPeer(abstractView), string2, n2, bl3, bl4, bl5, bl6);
    }
