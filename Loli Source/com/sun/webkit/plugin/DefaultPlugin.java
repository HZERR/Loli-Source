...
implements Plugin {
    ...
    @Override
    public boolean handleMouseEvent(String string, int n2, int n3, int n4, int n5, int n6, boolean bl, boolean bl2, boolean bl3, boolean bl4, boolean bl5, long l2) {
        return false;
    }
    ...
    @Override
    public void setNativeContainerBounds(int n2, int n3, int n4, int n5) {
    }
}
