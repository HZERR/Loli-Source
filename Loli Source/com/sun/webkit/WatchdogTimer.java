...
final class WatchdogTimer {
    ...
    private static WatchdogTimer fwkCreate(long l2) {
        return new WatchdogTimer(l2);
    }

    private void fwkStart(double d2) {
        if (this.future != null) {
            throw new IllegalStateException();
        }
        this.future = this.executor.schedule(this.runnable, (long)(d2 * 1000.0) + 50L, TimeUnit.MILLISECONDS);
    }
