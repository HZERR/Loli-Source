            ...
            public void run() {
                if (FXApplet2.this.application != null) {
                    ...
                    try {
                        ...
                        if (!PerformanceTracker.isLoggingEnabled() || (string = FXApplet2.this.application.getParameters().getNamed().get("sun_perflog_fx_launchtime")) == null || string.equals("")) return;
                        long l2 = Long.parseLong(string);
                        PerformanceLogger.setStartTime("LaunchTime", l2);
                        return;
                    }
                    catch (Throwable throwable) {
                        throwable.printStackTrace();
