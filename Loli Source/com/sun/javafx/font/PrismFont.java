...
implements PGFont {
    ...
    PrismFont(FontResource fontResource, String string, float f2) {
    ...
    @Override
    public FontStrike getStrike(BaseTransform baseTransform, int n2) {
        return this.fontResource.getStrike(this.fontSize, baseTransform, n2);
    }
