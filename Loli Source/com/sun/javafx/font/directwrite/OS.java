...
class OS {
    ...
    static final IDWriteFactory DWriteCreateFactory(int n2) {
        long l2 = OS._DWriteCreateFactory(n2);
        return l2 != 0L ? new IDWriteFactory(l2) : null;
    }

    private static final native long _D2D1CreateFactory(int var0);

    static final ID2D1Factory D2D1CreateFactory(int n2) {
        long l2 = OS._D2D1CreateFactory(n2);
        return l2 != 0L ? new ID2D1Factory(l2) : null;
    }

    private static final native long _WICCreateImagingFactory();

    static final IWICImagingFactory WICCreateImagingFactory() {
        long l2 = OS._WICCreateImagingFactory();
        return l2 != 0L ? new IWICImagingFactory(l2) : null;
    }

    private static final native long _NewJFXTextAnalysisSink(char[] var0, int var1, int var2, char[] var3, int var4, long var5);

    static final JFXTextAnalysisSink NewJFXTextAnalysisSink(char[] arrc, int n2, int n3, String string, int n4) {
        long l2 = OS._NewJFXTextAnalysisSink(arrc, n2, n3, (string + '\u0000').toCharArray(), n4, 0L);
        return l2 != 0L ? new JFXTextAnalysisSink(l2) : null;
    }

    private static final native long _NewJFXTextRenderer();

    static final JFXTextRenderer NewJFXTextRenderer() {
        long l2 = OS._NewJFXTextRenderer();
        return l2 != 0L ? new JFXTextRenderer(l2) : null;
    }
