...
extends IUnknown {
    ...
    void SetTextAntialiasMode(int n2) {
        OS.SetTextAntialiasMode(this.ptr, n2);
    }

    void DrawGlyphRun(D2D1_POINT_2F d2D1_POINT_2F, DWRITE_GLYPH_RUN dWRITE_GLYPH_RUN, ID2D1Brush iD2D1Brush, int n2) {
        OS.DrawGlyphRun(this.ptr, d2D1_POINT_2F, dWRITE_GLYPH_RUN, iD2D1Brush.ptr, n2);
    }

    ID2D1Brush CreateSolidColorBrush(D2D1_COLOR_F d2D1_COLOR_F) {
        long l2 = OS.CreateSolidColorBrush(this.ptr, d2D1_COLOR_F);
        return l2 != 0L ? new ID2D1Brush(l2) : null;
    }
}
