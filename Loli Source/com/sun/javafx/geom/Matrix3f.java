...
public class Matrix3f {
    ...
    public final void setRow(int n2, float[] arrf) {
        switch (n2) {
            case 0: {
                this.m00 = arrf[0];
                this.m01 = arrf[1];
    ...
    public final void setRow(int n2, Vec3f vec3f) {
        switch (n2) {
            case 0: {
                this.m00 = vec3f.x;
                this.m01 = vec3f.y;
    ...
    public final void getRow(int n2, Vec3f vec3f) {
        if (n2 == 0) {
            vec3f.x = this.m00;
            vec3f.y = this.m01;
            vec3f.z = this.m02;
    ...
    public final void getRow(int n2, float[] arrf) {
        if (n2 == 0) {
            arrf[0] = this.m00;
            arrf[1] = this.m01;
            arrf[2] = this.m02;
