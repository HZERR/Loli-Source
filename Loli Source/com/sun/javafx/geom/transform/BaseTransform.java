...
implements CanTransformVec3d {
    ...
    public static BaseTransform getInstance(double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9, double d10, double d11, double d12, double d13) {
        if (d4 == 0.0 && d8 == 0.0 && d10 == 0.0 && d11 == 0.0 && d12 == 1.0 && d13 == 0.0) {
            return BaseTransform.getInstance(d2, d6, d3, d7, d5, d9);
        }
        return new Affine3D(d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12, d13);
    }

    public static BaseTransform getInstance(double d2, double d3, double d4, double d5, double d6, double d7) {
        if (d2 == 1.0 && d3 == 0.0 && d4 == 0.0 && d5 == 1.0) {
            return BaseTransform.getTranslateInstance(d6, d7);
        }
        return new Affine2D(d2, d3, d4, d5, d6, d7);
    }

    public static BaseTransform getTranslateInstance(double d2, double d3) {
        if (d2 == 0.0 && d3 == 0.0) {
            return IDENTITY_TRANSFORM;
        }
    ...
    public static BaseTransform getScaleInstance(double d2, double d3) {
        return BaseTransform.getInstance(d2, 0.0, 0.0, d3, 0.0, 0.0);
    }

    public static BaseTransform getRotateInstance(double d2, double d3, double d4) {
        Affine2D affine2D = new Affine2D();
        affine2D.setToRotation(d2, d3, d4);
        return affine2D;
    }
    ...
    public int hashCode() {
        ...
        long l2 = 0L;
        l2 = l2 * 31L + Double.doubleToLongBits(this.getMzz());
        l2 = l2 * 31L + Double.doubleToLongBits(this.getMzy());
        l2 = l2 * 31L + Double.doubleToLongBits(this.getMzx());
        l2 = l2 * 31L + Double.doubleToLongBits(this.getMyz());
        l2 = l2 * 31L + Double.doubleToLongBits(this.getMxz());
        ...
        l2 = l2 * 31L + Double.doubleToLongBits(this.getMzt());
    ...
    public static boolean almostZero(double d2) {
