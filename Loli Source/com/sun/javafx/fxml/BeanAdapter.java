    ...
    public static Type getGenericListItemType(Type type) {
        ...
        while (type2 != null) {
            ...
            for (int i2 = 0; i2 < ((Type[])object2).length; ++i2) {
                ...
                if (!(type4 instanceof ParameterizedType) || !List.class.isAssignableFrom(class_ = (Class)(parameterizedType = (ParameterizedType)type4).getRawType())) continue;
    ...
    public static Type getGenericMapValueType(Type type) {
        ...
        while (type2 != null) {
            ...
            for (int i2 = 0; i2 < ((Type[])object2).length; ++i2) {
                ...
                Class class_;
                Type type4 = object2[i2];
                if (!(type4 instanceof ParameterizedType) || !Map.class.isAssignableFrom(class_ = (Class)(parameterizedType = (ParameterizedType)type4).getRawType())) continue;
        ...
        if (class_2 != null) {
            ...
            if (method == null) {
                ...
                for (int i2 = 0; i2 < arrclass.length; ++i2) {
                    try {
                        method = MethodUtil.getMethod(class_, string2, new Class[]{arrclass[i2]});
                    }
                    catch (NoSuchMethodException noSuchMethodException) {
                        // empty catch block
                    }
                    if (method == null) {
                        try {
                            method = MethodUtil.getMethod(class_, string3, new Class[]{arrclass[i2]});
                        }
                        catch (NoSuchMethodException noSuchMethodException) {
                            // empty catch block
                        }
    ...
    private static Method getStaticSetterMethod(Class<?> class_, String string, Class<?> class_2, Class<?> class_3) {
        ...
        if (class_3 != null) {
            ...
            if (method == null) {
                ...
                for (int i2 = 0; i2 < arrclass.length; ++i2) {
                    try {
                        method = MethodUtil.getMethod(class_, string2, new Class[]{arrclass[i2], class_2});
                    }
                    catch (NoSuchMethodException noSuchMethodException) {
                        // empty catch block
                    }
