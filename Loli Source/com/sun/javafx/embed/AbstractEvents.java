...
public class AbstractEvents {
    ...
    public static EventType<MouseEvent> mouseIDToFXEventID(int n2) {
        switch (n2) {
            case 0: {
    ...
    public static MouseButton mouseButtonToFXMouseButton(int n2) {
        switch (n2) {
            case 1: {
    ...
    public static EventType<KeyEvent> keyIDToFXEventType(int n2) {
        switch (n2) {
            case 0: {
    ...
    public static FocusCause focusCauseToPeerFocusCause(int n2) {
        switch (n2) {
            case 0: {
