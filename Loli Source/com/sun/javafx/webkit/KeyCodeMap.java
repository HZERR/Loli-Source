...
public final class KeyCodeMap {
    ...
    private static void put(Map<KeyCode, Entry> map, KeyCode keyCode, int n2, String string) {
        map.put(keyCode, new Entry(n2, string));
    }

    private static void put(Map<KeyCode, Entry> map, KeyCode keyCode, int n2) {
        KeyCodeMap.put(map, keyCode, n2, null);
    }

    public static Entry lookup(KeyCode keyCode) {
        Entry entry = MAP.get((Object)keyCode);
        if (entry == null || entry.getKeyIdentifier() == null) {
            int n2 = entry != null ? entry.getWindowsVirtualKeyCode() : 0;
            String string = String.format("U+%04X", n2);
            entry = new Entry(n2, string);
        }
        return entry;
    }
    ...
    public static final class Entry {
        ...
        private Entry(int n2, String string) {
