...
extends CursorManager<Cursor> {
    ...
    @Override
    protected Cursor getCustomCursor(WCImage wCImage, int n2, int n3) {
        return new ImageCursor(Image.impl_fromPlatformImage(WCGraphicsManager.getGraphicsManager().toPlatformImage(wCImage)), n2, n3);
    }

    @Override
    protected Cursor getPredefinedCursor(int n2) {
        switch (n2) {
            default: {
        ...
        if (cursor2 == null) {
            try {
                ...
                if (this.bundle != null) {
                    ...
                    cursor2 = new ImageCursor(image, n2, n3);
                }
            }
