...
extends StyleConverterImpl<ParsedValue<?, Paint>, Paint> {
    ...
    extends StyleConverterImpl<ParsedValue[], Paint> {
        ...
        public Paint convert(ParsedValue<ParsedValue[], Paint> parsedValue, Font font) {
            ...
            int n2 = 0;
            Size size = arrparsedValue[n2++] != null ? (Size)arrparsedValue[n2 - 1].convert(font) : null;
            Size size2 = arrparsedValue[n2++] != null ? (Size)arrparsedValue[n2 - 1].convert(font) : null;
            Size size3 = arrparsedValue[n2++] != null ? (Size)arrparsedValue[n2 - 1].convert(font) : null;
            Size size4 = arrparsedValue[n2++] != null ? (Size)arrparsedValue[n2 - 1].convert(font) : null;
            Size size5 = (Size)arrparsedValue[n2++].convert(font);
            ...
            CycleMethod cycleMethod = (CycleMethod)((Object)arrparsedValue[n2++].convert(font));
            Stop[] arrstop = new Stop[arrparsedValue.length - n2];
            for (int i2 = n2; i2 < arrparsedValue.length; ++i2) {
                arrstop[i2 - n2] = (Stop)arrparsedValue[i2].convert(font);
            }
            double d2 = 0.0;
            if (size != null) {
                d2 = size.pixels(font);
            ...
            paint = new RadialGradient(d2, size2 != null ? size2.pixels() : 0.0, size3 != null ? size3.pixels() : 0.0, size4 != null ? size4.pixels() : 0.0, size5 != null ? size5.pixels() : 1.0, bl2, cycleMethod, arrstop);
            super.cacheValue(parsedValue, paint);
            return paint;
        }
    ...
    extends StyleConverterImpl<ParsedValue[], Paint> {
        ...
        public Paint convert(ParsedValue<ParsedValue[], Paint> parsedValue, Font font) {
            ...
            ParsedValue[] arrparsedValue = parsedValue.getValue();
            int n2 = 0;
            Size size = (Size)arrparsedValue[n2++].convert(font);
            Size size2 = (Size)arrparsedValue[n2++].convert(font);
            Size size3 = (Size)arrparsedValue[n2++].convert(font);
            Size size4 = (Size)arrparsedValue[n2++].convert(font);
    ...
    extends StyleConverterImpl<ParsedValue<?, Paint>[], Paint[]> {
        ...
        public Paint[] convert(ParsedValue<ParsedValue<?, Paint>[], Paint[]> parsedValue, Font font) {
            ...
            for (int i2 = 0; i2 < arrparsedValue.length; ++i2) {
                arrpaint[i2] = arrparsedValue[i2].convert(font);
            }
            return arrpaint;
        }
