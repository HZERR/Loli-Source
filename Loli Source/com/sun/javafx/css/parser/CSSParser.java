...
public final class CSSParser {
    ...
    private void reportException(Exception exception) {
        ...
        if (LOGGER.isLoggable(PlatformLogger.Level.WARNING) && (arrstackTraceElement = exception.getStackTrace()).length > 0) {
            ...
            int n2 = 0;
            while (n2 < arrstackTraceElement.length && this.getClass().getName().equals(arrstackTraceElement[n2].getClassName())) {
                stringBuilder.append("\n\t").append(arrstackTraceElement[n2++].toString());
            }
    ...
    private Size size(Token token) throws ParseException {
        ...
        return new Size(Double.parseDouble(string.substring(0, n3 - n2)), sizeUnits);
    }
    ...
    ParsedValueImpl valueFor(String string, Term term, CSSLexer cSSLexer) throws ParseException {
        ...
        if ("-fx-stroke-dash-array".equals(string2)) {
            object = term;
            int n2 = this.numberOfTerms((Term)object);
            ParsedValueImpl[] arrparsedValueImpl = new ParsedValueImpl[n2];
            int n3 = 0;
            while (object != null) {
                arrparsedValueImpl[n3++] = this.parseSize((Term)object);
                object = ((Term)object).nextInSeries;
            }
        ...
        if ("-fx-font-smoothing-type".equals(string2)) {
            ...
            if (term.token == null || (n4 = term.token.getType()) != 10 && n4 != 11 || (object = term.token.getText()) == null || ((String)object).isEmpty()) {
    ...
    private ParsedValueImpl parse(Term term) throws ParseException {
        ...
        switch (n2) {
            ...
            case 37: {
                ...
                try {
                    parsedValueImpl = new ParsedValueImpl(Color.web(string), null);
                }
                catch (IllegalArgumentException illegalArgumentException) {
            ...
            default: {
                String string = "Unknown token type: '" + n2 + "'";
    ...
    private ParsedValueImpl rgb(Term term) throws ParseException {
        ...
        if ((n2 = token4.getType()) != token3.getType() || n2 != token2.getType() || n2 != 13 && n2 != 22) {
        ...
        double d4 = 0.0;
        if (n2 == 13) {
            d2 = this.clamp(0.0, Double.parseDouble(string3) / 255.0, 1.0);
            d3 = this.clamp(0.0, Double.parseDouble(string4) / 255.0, 1.0);
            d4 = this.clamp(0.0, Double.parseDouble(string5) / 255.0, 1.0);
        } else {
            d2 = this.clamp(0.0, Double.parseDouble(string3.substring(0, string3.length() - 1)) / 100.0, 1.0);
            d3 = this.clamp(0.0, Double.parseDouble(string4.substring(0, string4.length() - 1)) / 100.0, 1.0);
            d4 = this.clamp(0.0, Double.parseDouble(string5.substring(0, string5.length() - 1)) / 100.0, 1.0);
        }
        String string6 = token != null ? token.getText() : null;
        double d5 = string6 != null ? this.clamp(0.0, Double.parseDouble(string6), 1.0) : 1.0;
        return new ParsedValueImpl(Color.color(d2, d3, d4, d5), null);
    }
    ...
    private ParsedValueImpl hsb(Term term) throws ParseException {
        ...
        double d2 = size.pixels();
        double d3 = this.clamp(0.0, size2.pixels(), 1.0);
        double d4 = this.clamp(0.0, size3.pixels(), 1.0);
        Size size4 = token != null ? this.size(token) : null;
        double d5 = size4 != null ? this.clamp(0.0, size4.pixels(), 1.0) : 1.0;
    ...
    private ParsedValueImpl<ParsedValue[], Color> ladder(Term term) throws ParseException {
        ...
        ParsedValueImpl[] arrparsedValueImpl = new ParsedValueImpl[n2 + 1];
        ...
        do {
            ...
            if ((parsedValueImpl2 = this.stop(term2)) != null) {
                arrparsedValueImpl[n3++] = parsedValueImpl2;
            }
            term3 = term2;
    ...
    private ParsedValueImpl<ParsedValue[], Stop>[] parseColorStops(Term term) throws ParseException {
        ...
        ParsedValueImpl[] arrparsedValueImpl = new ParsedValueImpl[n2];
        Object[] arrobject = new Size[n2];
        Arrays.fill(arrobject, null);
        Term term3 = term;
        Term term4 = term;
        Object var8_8 = null;
        for (int i2 = 0; i2 < n2; ++i2) {
            arrparsedValueImpl[i2] = this.parseColor(term3);
            term4 = term3;
            Term term5 = term3.nextInSeries;
            if (term5 != null) {
                if (this.isSize(term5.token)) {
                    arrobject[i2] = this.size(term5.token);
                    if (var8_8 != null && var8_8 != ((Size)arrobject[i2]).getUnits()) {
        ...
        if (arrobject[n2 - 1] == null) {
            arrobject[n2 - 1] = new Size(100.0, SizeUnits.PERCENT);
        }
        Object object = null;
        for (int i3 = 1; i3 < n2; ++i3) {
            Object object2;
            Object object3 = arrobject[i3 - 1];
            if (object3 == null) continue;
            if (object == null || ((Size)object).getValue() < ((Size)object3).getValue()) {
                object = object3;
            }
            if ((object2 = arrobject[i3]) == null || !(((Size)object2).getValue() < ((Size)object).getValue())) continue;
            arrobject[i3] = object;
        }
        Object object4 = null;
        int n3 = -1;
        for (int i4 = 0; i4 < n2; ++i4) {
            Object object5 = arrobject[i4];
            if (object5 == null) {
                if (n3 != -1) continue;
                n3 = i4;
                continue;
            ...
            if (n3 > -1) {
                int n4 = i4 - n3;
                double d2 = ((Size)object4).getValue();
                double d3 = (((Size)object5).getValue() - d2) / (double)(n4 + 1);
                while (n3 < i4) {
                    arrobject[n3++] = new Size(d2 += d3, ((Size)object5).getUnits());
                }
                n3 = -1;
                object4 = object5;
                continue;
        ...
        ParsedValueImpl[] arrparsedValueImpl2 = new ParsedValueImpl[n2];
        for (int i5 = 0; i5 < n2; ++i5) {
            arrparsedValueImpl2[i5] = new ParsedValueImpl<ParsedValue[], Stop>(new ParsedValueImpl[]{new ParsedValueImpl(arrobject[i5], null), arrparsedValueImpl[i5]}, StopConverter.getInstance());
        }
    ...
    private ParsedValueImpl<ParsedValue[], Paint> linearGradient(Term term) throws ParseException {
        ...
        ParsedValueImpl[] arrparsedValueImpl3 = new ParsedValueImpl[n2];
        int n3 = 0;
        do {
        ...
        int n4 = 0;
        arrparsedValueImpl4[n4++] = arrparsedValueImpl != null ? arrparsedValueImpl[0] : null;
        arrparsedValueImpl4[n4++] = arrparsedValueImpl != null ? arrparsedValueImpl[1] : null;
        arrparsedValueImpl4[n4++] = arrparsedValueImpl2 != null ? arrparsedValueImpl2[0] : null;
        arrparsedValueImpl4[n4++] = arrparsedValueImpl2 != null ? arrparsedValueImpl2[1] : null;
        arrparsedValueImpl4[n4++] = parsedValueImpl;
        for (int i2 = 0; i2 < arrparsedValueImpl3.length; ++i2) {
            arrparsedValueImpl4[n4++] = arrparsedValueImpl3[i2];
        }
    ...
    private ParsedValueImpl parseLinearGradient(Term term) throws ParseException {
        ...
        if ("from".equalsIgnoreCase(term2.token.getText())) {
            ...
            if (term2.nextInSeries != null) {
                ...
                if (term2.token != null && term2.token.getType() == 11 && !term2.token.getText().isEmpty()) {
                    ...
                    if ("right".equals(string4) && n3 == 0 && n5 == 0) {
                        n3 = 0;
                        n5 = 100;
                    } else if ("left".equals(string4) && n3 == 0 && n5 == 0) {
                        n3 = 100;
                        n5 = 0;
                    } else if ("top".equals(string4) && n4 == 0 && n2 == 0) {
                        n4 = 100;
                        n2 = 0;
                    } else if ("bottom".equals(string4) && n4 == 0 && n2 == 0) {
                        n4 = 0;
                        n2 = 100;
                    } else {
                        this.error(term2, "Invalid '<side-or-corner>'");
            ...
            arrparsedValueImpl = new ParsedValueImpl[]{new ParsedValueImpl(new Size(n3, SizeUnits.PERCENT), null), new ParsedValueImpl(new Size(n4, SizeUnits.PERCENT), null)};
            arrparsedValueImpl2 = new ParsedValueImpl[]{new ParsedValueImpl(new Size(n5, SizeUnits.PERCENT), null), new ParsedValueImpl(new Size(n2, SizeUnits.PERCENT), null)};
            term3 = term2;
            term2 = term2.nextArg;
        }
        ...
        ParsedValueImpl[] arrparsedValueImpl4 = new ParsedValueImpl[5 + arrparsedValueImpl3.length];
        n2 = 0;
        arrparsedValueImpl4[n2++] = arrparsedValueImpl != null ? arrparsedValueImpl[0] : null;
        arrparsedValueImpl4[n2++] = arrparsedValueImpl != null ? arrparsedValueImpl[1] : null;
        arrparsedValueImpl4[n2++] = arrparsedValueImpl2 != null ? arrparsedValueImpl2[0] : null;
        arrparsedValueImpl4[n2++] = arrparsedValueImpl2 != null ? arrparsedValueImpl2[1] : null;
        arrparsedValueImpl4[n2++] = new ParsedValueImpl(cycleMethod.name(), new EnumConverter<CycleMethod>(CycleMethod.class));
        for (int i2 = 0; i2 < arrparsedValueImpl3.length; ++i2) {
            arrparsedValueImpl4[n2++] = arrparsedValueImpl3[i2];
        }
        return new ParsedValueImpl<ParsedValue[], Paint>(arrparsedValueImpl4, PaintConverter.LinearGradientConverter.getInstance());
    }
    ...
    private ParsedValueImpl<ParsedValue[], Paint> radialGradient(Term term) throws ParseException {
        ...
        do {
            if ((parsedValueImpl = this.stop(term2)) != null) {
                arrparsedValueImpl2[n3++] = parsedValueImpl;
            }
            term3 = term2;
        } while ((term2 = term2.nextInSeries) != null && term2.token.getType() == 34);
        parsedValueImpl = this.cycleMethod(term2);
        ...
        int n4 = 0;
        arrparsedValueImpl3[n4++] = parsedValueImpl2;
        arrparsedValueImpl3[n4++] = object2;
        arrparsedValueImpl3[n4++] = arrparsedValueImpl != null ? arrparsedValueImpl[0] : null;
        arrparsedValueImpl3[n4++] = arrparsedValueImpl != null ? arrparsedValueImpl[1] : null;
        arrparsedValueImpl3[n4++] = object;
        arrparsedValueImpl3[n4++] = parsedValueImpl;
        for (int i2 = 0; i2 < arrparsedValueImpl2.length; ++i2) {
            arrparsedValueImpl3[n4++] = arrparsedValueImpl2[i2];
        }
    ...
    private ParsedValueImpl parseRadialGradient(Term term) throws ParseException {
        ...
        arrparsedValueImpl3[n2++] = parsedValueImpl2;
        arrparsedValueImpl3[n2++] = arrparsedValueImpl2 != null ? arrparsedValueImpl2[0] : null;
        arrparsedValueImpl3[n2++] = arrparsedValueImpl2 != null ? arrparsedValueImpl2[1] : null;
        arrparsedValueImpl3[n2++] = parsedValueImpl3;
        arrparsedValueImpl3[n2++] = new ParsedValueImpl(((Enum)object).name(), new EnumConverter<CycleMethod>(CycleMethod.class));
        for (int i2 = 0; i2 < arrparsedValueImpl.length; ++i2) {
            arrparsedValueImpl3[n2++] = arrparsedValueImpl[i2];
        }
        return new ParsedValueImpl<ParsedValue[], Paint>(arrparsedValueImpl3, PaintConverter.RadialGradientConverter.getInstance());
    }
    ...
    private ParsedValueImpl<ParsedValue<?, Paint>[], Paint[]> parsePaintLayers(Term term) throws ParseException {
        int n2 = this.numberOfLayers(term);
        ParsedValueImpl[] arrparsedValueImpl = new ParsedValueImpl[n2];
        Term term2 = term;
        int n3 = 0;
        do {
            ...
            arrparsedValueImpl[n3++] = this.parse(term2);
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue[], Insets>[], Insets[]> parseInsetsLayers(Term term) throws ParseException {
        ...
        while (term2 != null) {
            ...
            arrparsedValueImpl[n3++] = new ParsedValueImpl<ParsedValue[], Insets>(arrparsedValueImpl2, InsetsConverter.getInstance());
            while (term2.nextInSeries != null) {
                term2 = term2.nextInSeries;
            }
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue[], Margins>[], Margins[]> parseMarginsLayers(Term term) throws ParseException {
        ...
        while (term2 != null) {
            ParsedValueImpl<?, Size>[] arrparsedValueImpl2 = this.parseSize1to4(term2);
            arrparsedValueImpl[n3++] = new ParsedValueImpl<ParsedValue[], Margins>(arrparsedValueImpl2, Margins.Converter.getInstance());
            while (term2.nextInSeries != null) {
                term2 = term2.nextInSeries;
            }
            term2 = this.nextLayer(term2);
    ...
    private ParsedValueImpl<Size, Size>[] parseSizeSeries(Term term) throws ParseException {
        ...
        return arrayList.toArray(new ParsedValueImpl[arrayList.size()]);
    }
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue<?, Size>[][], CornerRadii>[], CornerRadii[]> parseCornerRadius(Term term) throws ParseException {
        ...
        while (term2 != null) {
            ...
            for (n4 = 0; n4 < 4; ++n4) {
                arrparsedValueImpl2[0][n4] = parsedValueImpl;
                arrparsedValueImpl2[1][n4] = parsedValueImpl;
            }
            n4 = 0;
            int n8 = 0;
            Term term4 = term2;
            while (n4 <= 4 && n8 <= 4 && term2 != null) {
                if (term2.token.getType() == 32) {
                    ++n7;
                } else {
                    ParsedValueImpl<?, Size> parsedValueImpl2 = this.parseSize(term2);
                    if (n7 == 0) {
                        arrparsedValueImpl2[n7][n4++] = parsedValueImpl2;
                    } else {
                        arrparsedValueImpl2[n7][n8++] = parsedValueImpl2;
                    }
                }
                term4 = term2;
                term2 = term2.nextInSeries;
            ...
            if (parsedValueImpl.equals(arrparsedValueImpl2[0][0]) || parsedValueImpl.equals(arrparsedValueImpl2[1][0])) {
            ...
            if (parsedValueImpl.equals(arrparsedValueImpl2[0][1]) || parsedValueImpl.equals(arrparsedValueImpl2[1][1])) {
            ...
            if (parsedValueImpl.equals(arrparsedValueImpl2[0][2]) || parsedValueImpl.equals(arrparsedValueImpl2[1][2])) {
            ...
            if (parsedValueImpl.equals(arrparsedValueImpl2[0][3]) || parsedValueImpl.equals(arrparsedValueImpl2[1][3])) {
            ...
            arrparsedValueImpl[n3++] = new ParsedValueImpl(arrparsedValueImpl2, null);
    ...
    private ParsedValueImpl<ParsedValue[], BackgroundPosition> parseBackgroundPosition(Term term) throws ParseException {
        ...
        Object object4 = term;
        ParsedValueImpl<Size, Size> parsedValueImpl3 = term.token;
        Object object5 = ((Term)object4).nextInSeries;
        Object object6 = object5 != null ? ((Term)object5).token : null;
        Object object7 = object5 != null ? ((Term)object5).nextInSeries : null;
        Object object8 = object7 != null ? ((Term)object7).token : null;
        Object object9 = object7 != null ? ((Term)object7).nextInSeries : null;
        Object object10 = object3 = object9 != null ? ((Term)object9).token : null;
        if (parsedValueImpl3 != null && object6 != null && object8 == null && object3 == null) {
            object2 = ((Token)((Object)parsedValueImpl3)).getText();
            object = ((Token)object6).getText();
            if (("top".equals(object2) || "bottom".equals(object2)) && ("left".equals(object) || "right".equals(object) || "center".equals(object))) {
                ...
                object6 = parsedValueImpl3;
                parsedValueImpl3 = parsedValueImpl2;
                parsedValueImpl2 = object5;
                object5 = object4;
                object4 = parsedValueImpl2;
            }
        } else if (parsedValueImpl3 != null && object6 != null && object8 != null) {
            object2 = null;
            object = null;
            if (object3 != null) {
                if (("top".equals(((Token)((Object)parsedValueImpl3)).getText()) || "bottom".equals(((Token)((Object)parsedValueImpl3)).getText())) && ("left".equals(((Token)object8).getText()) || "right".equals(((Token)object8).getText()))) {
                    object2 = new Term[]{object7, object9, object4, object5};
                    object = new Token[]{object8, object3, parsedValueImpl3, object6};
                }
            } else if ("top".equals(((Token)((Object)parsedValueImpl3)).getText()) || "bottom".equals(((Token)((Object)parsedValueImpl3)).getText())) {
                if ("left".equals(((Token)object6).getText()) || "right".equals(((Token)object6).getText())) {
                    object2 = new Term[]{object5, object7, object4, null};
                    object = new Token[]{object6, object8, parsedValueImpl3, null};
                } else {
                    object2 = new Term[]{object7, object4, object5, null};
                    object = new Token[]{object8, parsedValueImpl3, object6, null};
                }
            }
            if (object2 != null) {
                object4 = object2[0];
        ...
        if (parsedValueImpl3 == null && object6 == null && object8 == null && object3 == null) {
        ...
        } else if (parsedValueImpl3 != null && object6 == null && object8 == null && object3 == null) {
            arrparsedValueImpl = ((Token)((Object)parsedValueImpl3)).getText();
            if ("center".equals(arrparsedValueImpl)) {
                ...
                parsedValueImpl = this.parseSize((Term)object4);
                object = ZERO_PERCENT;
                object2 = FIFTY_PERCENT;
                parsedValueImpl2 = ZERO_PERCENT;
            }
        } else if (parsedValueImpl3 != null && object6 != null && object8 == null && object3 == null) {
            arrparsedValueImpl = ((Token)((Object)parsedValueImpl3)).getText().toLowerCase(Locale.ROOT);
            String string = ((Token)object6).getText().toLowerCase(Locale.ROOT);
            if (!CSSParser.isPositionKeyWord((String)arrparsedValueImpl)) {
                ...
                if ("top".equals(string)) {
                    ...
                    object2 = this.parseSize((Term)object5);
                    parsedValueImpl2 = ZERO_PERCENT;
                } else {
                    this.error((Term)object5, "Expected 'top', 'bottom', 'center' or <size>");
                }
            ...
            arrparsedValueImpl = ((Token)((Object)parsedValueImpl3)).getText().toLowerCase(Locale.ROOT);
            String string = ((Token)object6).getText().toLowerCase(Locale.ROOT);
            String string2 = ((Token)object8).getText().toLowerCase(Locale.ROOT);
            if (!CSSParser.isPositionKeyWord((String)arrparsedValueImpl) || "center".equals(arrparsedValueImpl)) {
                parsedValueImpl = "center".equals(arrparsedValueImpl) ? FIFTY_PERCENT : this.parseSize((Term)object4);
                object = ZERO_PERCENT;
                if (!CSSParser.isPositionKeyWord(string2)) {
                    if ("top".equals(string)) {
                        ...
                        object2 = ZERO_PERCENT;
                        parsedValueImpl2 = this.parseSize((Term)object7);
                    } else {
                        this.error((Term)object5, "Expected 'top' or 'bottom'");
                    }
                } else {
                    this.error((Term)object7, "Expected <size>");
                }
                ...
                if (!CSSParser.isPositionKeyWord(string)) {
                    if ("left".equals(arrparsedValueImpl)) {
                        ...
                        parsedValueImpl = ZERO_PERCENT;
                        object = this.parseSize((Term)object5);
                    }
                    if ("top".equals(string2)) {
                        ...
                        this.error((Term)object7, "Expected 'top', 'bottom' or 'center'");
                    }
                } else {
                    if ("left".equals(arrparsedValueImpl)) {
                        parsedValueImpl = ZERO_PERCENT;
            ...
            arrparsedValueImpl = ((Token)((Object)parsedValueImpl3)).getText().toLowerCase(Locale.ROOT);
            String string = ((Token)object6).getText().toLowerCase(Locale.ROOT);
            String string3 = ((Token)object8).getText().toLowerCase(Locale.ROOT);
            String string4 = ((Token)object3).getText().toLowerCase(Locale.ROOT);
            if ((arrparsedValueImpl.equals("left") || arrparsedValueImpl.equals("right")) && (string3.equals("top") || string3.equals("bottom")) && !CSSParser.isPositionKeyWord(string) && !CSSParser.isPositionKeyWord(string4)) {
                ...
                if (string3.equals("top")) {
                    object2 = this.parseSize((Term)object9);
                    parsedValueImpl2 = ZERO_PERCENT;
                } else {
                    object2 = ZERO_PERCENT;
                    parsedValueImpl2 = this.parseSize((Term)object9);
                }
            } else {
                this.error(term, "Expected 'left' or 'right' followed by <size> followed by 'top' or 'bottom' followed by <size>");
            }
        }
        arrparsedValueImpl = new ParsedValueImpl[]{object2, object, parsedValueImpl2, parsedValueImpl};
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue[], BackgroundPosition>[], BackgroundPosition[]> parseBackgroundPositionLayers(Term term) throws ParseException {
        ...
        Term term2 = term;
        while (term2 != null) {
            arrparsedValueImpl[n3++] = this.parseBackgroundPosition(term2);
            term2 = this.nextLayer(term2);
        }
    ...
    private ParsedValueImpl<ParsedValue<String, BackgroundRepeat>[][], RepeatStruct[]> parseBorderImageRepeatStyleLayers(Term term) throws ParseException {
        int n2 = this.numberOfLayers(term);
        ParsedValueImpl[][] arrarrparsedValueImpl = new ParsedValueImpl[n2][];
        int n3 = 0;
        Term term2 = term;
        while (term2 != null) {
            arrarrparsedValueImpl[n3++] = this.parseRepeatStyle(term2);
            term2 = this.nextLayer(term2);
        }
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue[], BackgroundSize>[], BackgroundSize[]> parseBackgroundSizeLayers(Term term) throws ParseException {
        ...
        Term term2 = term;
        while (term2 != null) {
            arrparsedValueImpl[n3++] = this.parseBackgroundSize(term2);
            term2 = this.nextLayer(term2);
        }
    ...
    private ParsedValueImpl<ParsedValue<?, Paint>[], Paint[]> parseBorderPaint(Term term) throws ParseException {
        ...
        int n2 = 0;
        while (term2 != null) {
            if (term2.token == null || arrparsedValueImpl.length <= n2) {
                this.error(term2, "Expected '<paint>'");
            }
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue<?, Paint>[], Paint[]>[], Paint[][]> parseBorderPaintLayers(Term term) throws ParseException {
        ...
        Term term2 = term;
        while (term2 != null) {
            arrparsedValueImpl[n3++] = this.parseBorderPaint(term2);
            term2 = this.nextLayer(term2);
        }
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue[], BorderStrokeStyle>[], BorderStrokeStyle[]> parseBorderStyleSeries(Term term) throws ParseException {
        ...
        int n2 = 0;
        while (term2 != null) {
            arrparsedValueImpl[n2++] = this.parseBorderStyle(term2);
            term2 = term2.nextInSeries;
        }
        if (n2 < 2) {
            arrparsedValueImpl[1] = arrparsedValueImpl[0];
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue<ParsedValue[], BorderStrokeStyle>[], BorderStrokeStyle[]>[], BorderStrokeStyle[][]> parseBorderStyleLayers(Term term) throws ParseException {
        ...
        Term term2 = term;
        while (term2 != null) {
            arrparsedValueImpl[n3++] = this.parseBorderStyleSeries(term2);
            term2 = this.nextLayer(term2);
        }
    ...
    private ParsedValueImpl<ParsedValue[], BorderStrokeStyle> parseBorderStyle(Term term) throws ParseException {
        ...
        if ("phase".equals(string)) {
            ...
            arrparsedValue = this.parseSize(term2);
            parsedValueImpl = new ParsedValueImpl((ParsedValue<?, Size>)arrparsedValue, SizeConverter.getInstance());
            term3 = term2;
            term2 = term2.nextInSeries;
        }
        ...
        if ("line-join".equals(string = this.getKeyword(term2))) {
            term3 = term2;
            term2 = term2.nextInSeries;
            arrparsedValue = this.parseStrokeLineJoin(term2);
            if (arrparsedValue != null) {
                parsedValueImpl3 = arrparsedValue[0];
                parsedValueImpl4 = arrparsedValue[1];
            } else {
        ...
        arrparsedValue = new ParsedValue[]{parsedValue, parsedValueImpl, parsedValueImpl2, parsedValueImpl3, parsedValueImpl4, parsedValueImpl5};
        return new ParsedValueImpl<ParsedValue[], BorderStrokeStyle>(arrparsedValue, BorderStyleConverter.getInstance());
    }
    ...
    private ParsedValueImpl<ParsedValue[], Number[]> segments(Term term) throws ParseException {
        ...
        int n2 = this.numberOfArgs(term);
        ParsedValueImpl[] arrparsedValueImpl = new ParsedValueImpl[n2];
        int n3 = 0;
        while (term2 != null) {
            arrparsedValueImpl[n3++] = this.parseSize(term2);
            term2 = term2.nextArg;
        }
        return new ParsedValueImpl<ParsedValue[], Number[]>(arrparsedValueImpl, SizeConverter.SequenceConverter.getInstance());
    }
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue[], BorderImageSlices>[], BorderImageSlices[]> parseBorderImageSliceLayers(Term term) throws ParseException {
        ...
        Term term2 = term;
        while (term2 != null) {
            arrparsedValueImpl[n3++] = this.parseBorderImageSlice(term2);
            term2 = this.nextLayer(term2);
        }
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue[], BorderWidths>[], BorderWidths[]> parseBorderImageWidthLayers(Term term) throws ParseException {
        ...
        Term term2 = term;
        while (term2 != null) {
            arrparsedValueImpl[n3++] = this.parseBorderImageWidth(term2);
            term2 = this.nextLayer(term2);
        }
    ...
    private ParsedValueImpl<ParsedValue<ParsedValue[], String>[], String[]> parseURILayers(Term term) throws ParseException {
        ...
        ParsedValueImpl[] arrparsedValueImpl = new ParsedValueImpl[n2];
        while (term2 != null) {
            arrparsedValueImpl[n3++] = this.parseURI(term2);
            term2 = this.nextLayer(term2);
        }
    ...
    private ParsedValueImpl<ParsedValue<?, Size>, Number> parseFontSize(Term term) throws ParseException {
        ...
        if (token.getType() == 11) {
            ...
            if (d2 > -1.0) {
                size = new Size(d2, SizeUnits.PERCENT);
            }
        }
        if (size == null) {
        ...
        return new ParsedValueImpl(object, FontConverter.FontSizeConverter.getInstance());
    }
    ...
    private ParsedValueImpl<String, FontWeight> parseFontWeight(Term term) throws ParseException {
        ...
        if ("inherit".equals(string)) {
            ...
            string2 = FontWeight.findByWeight(100).name();
        } else if ("200".equals(string)) {
            string2 = FontWeight.findByWeight(200).name();
        } else if ("300".equals(string)) {
            string2 = FontWeight.findByWeight(300).name();
        } else if ("400".equals(string)) {
            string2 = FontWeight.findByWeight(400).name();
        } else if ("500".equals(string)) {
            string2 = FontWeight.findByWeight(500).name();
        } else if ("600".equals(string)) {
            string2 = FontWeight.findByWeight(600).name();
        } else if ("700".equals(string)) {
            string2 = FontWeight.findByWeight(700).name();
        } else if ("800".equals(string)) {
            string2 = FontWeight.findByWeight(800).name();
        } else if ("900".equals(string)) {
            string2 = FontWeight.findByWeight(900).name();
        } else {
            this.error(term, "Expected '<font-weight>'");
        }
    ...
    private void parse(Stylesheet stylesheet, CSSLexer cSSLexer) {
        ...
        while (this.currentToken != null && this.currentToken.getType() == 47) {
            ...
            if (!imports.contains(this.sourceOfStylesheet)) {
                ...
                string = MessageFormat.format("Recursive @import at {2} [{0,number,#},{1,number,#}]", n2, n3, imports.peek());
        ...
        while (this.currentToken != null && this.currentToken.getType() != -1) {
            ...
            if (this.currentToken == null || this.currentToken.getType() != 28) {
                ...
                string = MessageFormat.format("Expected LBRACE at [{0,number,#},{1,number,#}]", n4, n5);
                object = this.createError(string);
                if (LOGGER.isLoggable(PlatformLogger.Level.WARNING)) {
                    LOGGER.warning(((CssError)object).toString());
                }
            ...
            if (this.currentToken != null && this.currentToken.getType() != 29) {
                ...
                object = MessageFormat.format("Expected RBRACE at [{0,number,#},{1,number,#}]", n6, n7);
            ...
            if ("src".equalsIgnoreCase(string)) {
                while (this.currentToken != null && this.currentToken.getType() != 30 && this.currentToken.getType() != 29 && this.currentToken.getType() != -1) {
                    ...
                    if (this.currentToken.getType() == 11) {
                        ...
                        ParsedValueImpl<ParsedValue[], String> parsedValueImpl = new ParsedValueImpl<ParsedValue[], String>(arrparsedValueImpl, URLConverter.getInstance());
                        String string2 = (String)((ParsedValue)parsedValueImpl).convert(null);
                        object = null;
                        try {
                            ...
                            n3 = this.currentToken.getLine();
                            int n4 = this.currentToken.getOffset();
                            String string3 = MessageFormat.format("Could not resolve @font-face url [{2}] at [{0,number,#},{1,number,#}]", n3, n4, string2);
                            ...
                            while (this.currentToken != null) {
                                int n5 = this.currentToken.getType();
                                if (n5 == 29 || n5 == -1) {
                                    return null;
                                }
                                this.currentToken = this.nextToken(cSSLexer);
                        ...
                        while (true) {
                            this.currentToken = this.nextToken(cSSLexer);
                            int n6 = n3 = this.currentToken != null ? this.currentToken.getType() : -1;
                            if (n3 == 12) {
                        ...
                        if ("local(".equalsIgnoreCase(this.currentToken.getText())) {
                            ...
                            if (stringBuilder.charAt(n2) == '\'' || stringBuilder.charAt(n2) == '\"') {
                                ++n2;
                            }
                            if (stringBuilder.charAt(n7 - 1) == '\'' || stringBuilder.charAt(n7 - 1) == '\"') {
                                --n7;
                            }
                            object = stringBuilder.substring(n2, n7);
                            arrayList.add(new FontFace.FontFaceSrc(FontFace.FontFaceSrcType.LOCAL, (String)object));
                        } else {
                            int n8 = this.currentToken.getLine();
                            n2 = this.currentToken.getOffset();
                            String string4 = MessageFormat.format("Unknown @font-face src type [" + this.currentToken.getText() + ")] at [{0,number,#},{1,number,#}]", n8, n2);
                        ...
                        n2 = this.currentToken.getOffset();
                        String string5 = MessageFormat.format("Unexpected TOKEN [" + this.currentToken.getText() + "] at [{0,number,#},{1,number,#}]", n9, n2);
    ...
    private Stylesheet handleImport(CSSLexer cSSLexer) {
        ...
        if (string != null) {
            ...
            String string3 = (String)((ParsedValue)object).convert(null);
    ...
    private Declaration declaration(CSSLexer cSSLexer) {
        ...
        if (this.currentToken == null || this.currentToken.getType() != 31) {
            int n4 = this.currentToken.getLine();
            int n5 = this.currentToken.getOffset();
            String string2 = MessageFormat.format("Expected COLON at [{0,number,#},{1,number,#}]", n4, n5);
            CssError cssError = this.createError(string2);
            if (LOGGER.isLoggable(PlatformLogger.Level.WARNING)) {
                LOGGER.warning(cssError.toString());
            }
        ...
        try {
            ...
            int n6 = token != null ? token.getLine() : -1;
            int n7 = token != null ? token.getOffset() : -1;
            String string3 = MessageFormat.format("{2} while parsing ''{3}'' at [{0,number,#},{1,number,#}]", n6, n7, parseException.getMessage(), string);
            CssError cssError = this.createError(string3);
            if (LOGGER.isLoggable(PlatformLogger.Level.WARNING)) {
                LOGGER.warning(cssError.toString());
            }
    ...
    private Term expr(CSSLexer cSSLexer) {
        ...
        while (true) {
            int n2;
            int n3 = n2 = term2 != null && this.currentToken != null ? this.currentToken.getType() : 0;
            if (n2 == 0) {
    ...
    private Term term(CSSLexer cSSLexer) {
        ...
        switch (n2) {
            ...
            case 34: {
                ...
                while (true) {
                    int n3;
                    int n4 = n3 = this.currentToken != null ? this.currentToken.getType() : 0;
                    if (n3 == 35) {
                        this.currentToken = this.nextToken(cSSLexer);
                        return term2;
                    }
            ...
            default: {
                ...
                String string2 = MessageFormat.format("Unexpected token {0}{1}{0} at [{2,number,#},{3,number,#}]", "'", string, n5, n6);
                CssError cssError = this.createError(string2);
                if (LOGGER.isLoggable(PlatformLogger.Level.WARNING)) {
                    LOGGER.warning(cssError.toString());
                }
