...
public final class SelectorPartitioning {
    ...
    void partition(Selector selector) {
        ...
        if (selector instanceof CompoundSelector) {
            ...
            n2 = object.size() - 1;
            simpleSelector = (SimpleSelector)object.get(n2);
        } else {
            simpleSelector = (SimpleSelector)selector;
        }
        object = simpleSelector.getId();
        n2 = object != null && !((String)object).isEmpty() ? 1 : 0;
        PartitionKey partitionKey = n2 != 0 ? new PartitionKey(object) : null;
        ...
        int n3 = (n2 != 0 ? 4 : 0) | (bl ? 2 : 0) | (bl2 ? 1 : 0);
    ...
    private static final class PartitionKey<K> {
        ...
        public int hashCode() {
            int n2 = 7;
            n2 = 71 * n2 + (this.key != null ? this.key.hashCode() : 0);
            return n2;
        }
    }
}
