...
implements EmbeddedSceneDTInterface {
    ...
    @Override
    public TransferMode handleDragEnter(int n2, int n3, int n4, int n5, TransferMode transferMode, EmbeddedSceneDSInterface embeddedSceneDSInterface) {
        ...
        return this.dnd.executeOnFXThread(() -> {
            ...
            return this.dndHandler.handleDragEnter(n2, n3, n4, n5, transferMode, this.assistant);
        });
    }
    ...
    @Override
    public TransferMode handleDragDrop(int n2, int n3, int n4, int n5, TransferMode transferMode) {
        assert (this.dnd.isHostThread());
        return this.dnd.executeOnFXThread(() -> {
            assert (this.assistant != null);
            try {
                TransferMode transferMode2 = this.dndHandler.handleDragDrop(n2, n3, n4, n5, transferMode, this.assistant);
    ...
    @Override
    public TransferMode handleDragOver(int n2, int n3, int n4, int n5, TransferMode transferMode) {
        assert (this.dnd.isHostThread());
        return this.dnd.executeOnFXThread(() -> {
            assert (this.assistant != null);
            return this.dndHandler.handleDragOver(n2, n3, n4, n5, transferMode, this.assistant);
        });
    }
