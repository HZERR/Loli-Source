...
implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            boolean bl3 = bl2 = this.penScale != f2 || this.penWidth != this.viewWidth || this.penHeight != this.viewHeight || this.rttexture == null || this.rttexture.getContentWidth() != n2 || this.rttexture.getContentHeight() != n3;
            if (!bl2) {
                this.rttexture.lock();
