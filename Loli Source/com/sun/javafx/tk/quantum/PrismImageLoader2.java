...
implements ImageLoader {
    ...
    public PrismImageLoader2(String string, int n2, int n3, boolean bl, float f2, boolean bl2) {
        this.loadAll(string, n2, n3, bl, f2, bl2);
    }

    public PrismImageLoader2(InputStream inputStream, int n2, int n3, boolean bl, boolean bl2) {
        this.loadAll(inputStream, n2, n3, bl, bl2);
    }
    ...
    private void loadAll(String string, int n2, int n3, boolean bl, float f2, boolean bl2) {
        PrismLoadListener prismLoadListener = new PrismLoadListener();
        try {
            ImageFrame[] arrimageFrame = ImageStorage.loadAll(string, (ImageLoadListener)prismLoadListener, n2, n3, bl, f2, bl2);
    ...
    private void loadAll(InputStream inputStream, int n2, int n3, boolean bl, boolean bl2) {
        PrismLoadListener prismLoadListener = new PrismLoadListener();
        try {
            ImageFrame[] arrimageFrame = ImageStorage.loadAll(inputStream, (ImageLoadListener)prismLoadListener, n2, n3, bl, 1.0f, bl2);
            this.convertAll(arrimageFrame);
        }
        catch (ImageStorageException imageStorageException) {
            this.handleException(imageStorageException);
    ...
    extends AbstractRemoteResource<PrismImageLoader2> {
        ...
        public AsyncImageLoader(AsyncOperationListener<PrismImageLoader2> asyncOperationListener, String string, int n2, int n3, boolean bl, boolean bl2) {
    ...
    implements ImageLoadListener {
        ...
        @Override
        public void imageLoadProgress(com.sun.javafx.iio.ImageLoader imageLoader, float f2) {
        }
