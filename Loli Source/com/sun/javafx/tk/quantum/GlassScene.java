...
implements TKScene {
    ...
    public final void setSecurityContext(AccessControlContext accessControlContext) {
        ...
        this.accessCtrlCtx = javaSecurityAccess.doIntersectionPrivilege(() -> AccessController.getContext(), accessControlContext2, accessControlContext);
    }
    ...
    public TKClipboard createDragboard(boolean bl) {
        ClipboardAssistance clipboardAssistance = new ClipboardAssistance("DND"){
            ...
            public void actionPerformed(int n2) {
                super.actionPerformed(n2);
                AccessController.doPrivileged(() -> {
                    try {
                        if (GlassScene.this.dragSourceListener != null) {
                            GlassScene.this.dragSourceListener.dragDropEnd(0.0, 0.0, 0.0, 0.0, QuantumToolkit.clipboardActionToTransferMode(n2));
                        }
                    }
                    finally {
