...
extends Toolkit {
    ...
    @Override
    public AsyncOperation loadImageAsync(AsyncOperationListener<? extends ImageLoader> asyncOperationListener, String string, int n2, int n3, boolean bl, boolean bl2) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
