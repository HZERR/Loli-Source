...
extends ComboBoxPopupControl<Color> {
    ...
    static String tooltipString(Color color) {
        if (color != null) {
            String string = "";
            String string2 = colorNameMap.get(color);
            if (string2 != null) {
                string = string + string2 + " ";
            }
            string = string + ColorPickerSkin.formatHexString(color);
            String string3 = cssNameMap.get(color);
            if (string3 != null) {
    ...
    extends StackPane {
        ...
        protected void layoutChildren() {
            ...
            double d6 = this.snappedRightInset();
            ...
            if (this.getChildren().size() == 2) {
                ...
                this.layoutInArea(imageView, d3, d2, d4 - d3 - d6, d5 - d2 - d7, 0.0, PickerColorBox.getMargin(imageView), pos != null ? pos.getHpos() : this.getAlignment().getHpos(), pos != null ? pos.getVpos() : this.getAlignment().getVpos());
                ...
                this.layoutInArea(ColorPickerSkin.this.colorRect, d3, d2, d4 - d3 - d6, d5 - d2 - d7, 0.0, PickerColorBox.getMargin(ColorPickerSkin.this.colorRect), pos != null ? pos.getHpos() : this.getAlignment().getHpos(), pos != null ? pos.getVpos() : this.getAlignment().getVpos());
            }
        }
    }
}
