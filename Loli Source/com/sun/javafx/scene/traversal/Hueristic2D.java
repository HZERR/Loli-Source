...
implements Algorithm {
    ...
    protected Node getNearestNodeUpOrDown(Bounds bounds, Bounds bounds2, TraversalContext traversalContext, Direction direction) {
        ...
        for (int i2 = 0; i2 < list.size(); ++i2) {
            ...
            if (this.isOnAxis(direction, boundingBox, bounds3)) {
                targetNode.biased2DMetric = d4 + this.centerSideDistance(direction, boundingBox, bounds3) / 100.0;
            } else {
                d3 = this.cornerSideDistance(direction, boundingBox, bounds3);
                targetNode.biased2DMetric = 100000.0 + d4 * d4 + 9.0 * d3 * d3;
            }
            d3 = Math.max(0.0, this.outDistance(direction, bounds, bounds3));
            if (this.isOnAxis(direction, bounds, bounds3)) {
                targetNode.current2DMetric = d3 + this.centerSideDistance(direction, bounds, bounds3) / 100.0;
            } else {
                d2 = this.cornerSideDistance(direction, bounds, bounds3);
                targetNode.current2DMetric = 100000.0 + d3 * d3 + 9.0 * d2 * d2;
            }
            ...
            d2 = point2D.distance(bounds3.getMinX() + bounds3.getWidth() / 2.0, function2.apply(bounds3));
            double d5 = point2D3.distance(bounds3.getMinX() + bounds3.getWidth() / 2.0, function2.apply(bounds3));
            double d6 = point2D3.distance(bounds3.getMaxX(), function2.apply(bounds3));
            double d7 = point2D5.distance(bounds3.getMinX(), function2.apply(bounds3));
            double d8 = point2D5.distance(bounds3.getMinX() + bounds3.getWidth() / 2.0, function2.apply(bounds3));
            double d9 = point2D5.distance(bounds3.getMaxX(), function2.apply(bounds3));
            double d10 = point2D.distance(bounds3.getMinX(), function2.apply(bounds3));
            double d11 = point2D.distance(bounds3.getMinX() + bounds3.getWidth() / 2.0, function2.apply(bounds3));
            double d12 = point2D.distance(bounds3.getMaxX(), function2.apply(bounds3));
            double d13 = point2D4.distance(bounds3.getMinX() + bounds3.getWidth() / 2.0, function2.apply(bounds3));
            double d14 = point2D4.distance(bounds3.getMaxX(), function2.apply(bounds3));
            double d15 = point2D6.distance(bounds3.getMinX() + bounds3.getWidth() / 2.0, function2.apply(bounds3));
            double d16 = point2D2.distance(bounds3.getMaxX(), function2.apply(bounds3));
            targetNode.averageDistance = (targetNode.leftCornerDistance + d13 + d14 + d7 + targetNode.rightCornerDistance + d15 + d2) / 7.0;
            targetNode.biasShortestDistance = Hueristic2D.findMin(targetNode.leftCornerDistance, d13, d14, d7, d15, targetNode.rightCornerDistance, d10, d2, d16);
            targetNode.shortestDistance = Hueristic2D.findMin(targetNode.leftCornerDistance, d5, d6, d7, d8, d9, d10, d11, d12);
            if (d4 >= 0.0 && (targetNode3 == null || targetNode.biased2DMetric < targetNode3.biased2DMetric)) {
                if (targetNode3 == null) {
                    targetNode3 = new TargetNode();
                }
                targetNode3.copy(targetNode);
            }
            if (d3 >= 0.0 && (targetNode2 == null || targetNode.current2DMetric < targetNode2.current2DMetric)) {
                if (targetNode2 == null) {
    ...
    protected Node getNearestNodeLeftOrRight(Bounds bounds, Bounds bounds2, TraversalContext traversalContext, Direction direction) {
        ...
        for (int i2 = 0; i2 < list.size(); ++i2) {
            ...
            d2 = point2D.distance(function2.apply(bounds3), bounds3.getMinY() + bounds3.getHeight() / 2.0);
            double d5 = point2D3.distance(function2.apply(bounds3), bounds3.getMaxY());
            double d6 = point2D3.distance(function2.apply(bounds3), bounds3.getMinY() + bounds3.getHeight() / 2.0);
            double d7 = point2D5.distance(function2.apply(bounds3), bounds3.getMinY());
            double d8 = point2D5.distance(function2.apply(bounds3), bounds3.getMaxY());
            double d9 = point2D5.distance(function2.apply(bounds3), bounds3.getMinY() + bounds3.getHeight() / 2.0);
            double d10 = point2D.distance(function2.apply(bounds3), bounds3.getMinY());
            double d11 = point2D.distance(function2.apply(bounds3), bounds3.getMaxY());
            double d12 = point2D.distance(function2.apply(bounds3), bounds3.getMinY() + bounds3.getHeight() / 2.0);
            double d13 = point2D4.distance(function2.apply(bounds3), bounds3.getMaxY());
            double d14 = point2D4.distance(function2.apply(bounds3), bounds3.getMinY() + bounds3.getHeight() / 2.0);
            double d15 = point2D6.distance(function2.apply(bounds3), bounds3.getMinY() + bounds3.getHeight() / 2.0);
            double d16 = point2D2.distance(function2.apply(bounds3), bounds3.getMaxY());
            targetNode.averageDistance = (targetNode.topCornerDistance + d13 + d14 + d7 + targetNode.bottomCornerDistance + d15 + d2) / 7.0;
            targetNode.biasShortestDistance = Hueristic2D.findMin(targetNode.topCornerDistance, d13, d14, d7, targetNode.bottomCornerDistance, d15, d10, d16, d2);
            targetNode.shortestDistance = Hueristic2D.findMin(targetNode.topCornerDistance, d5, d6, d7, d8, d9, d10, d11, d12);
            if (d4 >= 0.0 && (targetNode3 == null || targetNode.biased2DMetric < targetNode3.biased2DMetric)) {
                if (targetNode3 == null) {
                    targetNode3 = new TargetNode();
                }
