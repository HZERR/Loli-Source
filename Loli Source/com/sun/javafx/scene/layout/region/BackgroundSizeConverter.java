...
extends StyleConverterImpl<ParsedValue[], BackgroundSize> {
    ...
    public BackgroundSize convert(ParsedValue<ParsedValue[], BackgroundSize> parsedValue, Font font) {
        ...
        boolean bl4 = arrparsedValue[2] != null ? BooleanConverter.getInstance().convert(arrparsedValue[2], font) : false;
        boolean bl5 = arrparsedValue[3] != null ? BooleanConverter.getInstance().convert(arrparsedValue[3], font) : false;
        return new BackgroundSize(d2, d3, bl, bl2, bl5, bl4);
    }
