...
public final class WindowHelper {
    ...
    public static void notifyLocationChanged(Window window, double d2, double d3) {
        windowAccessor.notifyLocationChanged(window, d2, d3);
    }

    public static void notifySizeChanged(Window window, double d2, double d3) {
        windowAccessor.notifySizeChanged(window, d2, d3);
    }
