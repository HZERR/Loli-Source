...
public abstract class Application {
    ...
    public final Window createWindow(Screen screen, int n2) {
        return this.createWindow(null, screen, n2);
    }
    ...
    public final MenuItem createMenuItem(String string, MenuItem.Callback callback, int n2, int n3) {
        return this.createMenuItem(string, callback, n2, n3, null);
    }

    public final MenuItem createMenuItem(String string, MenuItem.Callback callback, int n2, int n3, Pixels pixels) {
        return new MenuItem(string, callback, n2, n3, pixels);
    }
    ...
    static Pixels createPixels(int n2, int n3, int[] arrn, float f2) {
        return Application.GetApplication().createPixels(n2, n3, IntBuffer.wrap(arrn), f2);
    }

    static float getScaleFactor(int n2, int n3, int n4, int n5) {
        float f2 = 0.0f;
        for (Screen screen : Screen.getScreens()) {
            int n6 = screen.getX();
            int n7 = screen.getY();
            int n8 = screen.getWidth();
            int n9 = screen.getHeight();
            if (n2 >= n6 + n8 || n2 + n4 <= n6 || n3 >= n7 + n9 || n3 + n5 <= n7 || !(f2 < screen.getRenderScale())) continue;
            f2 = screen.getRenderScale();
        }
    ...
    public static class EventHandler {
        public void handleWillFinishLaunchingAction(Application application, long l2) {
        }

        public void handleDidFinishLaunchingAction(Application application, long l2) {
        }

        public void handleWillBecomeActiveAction(Application application, long l2) {
        }

        public void handleDidBecomeActiveAction(Application application, long l2) {
        }

        public void handleWillResignActiveAction(Application application, long l2) {
        }

        public void handleDidResignActiveAction(Application application, long l2) {
        }

        public void handleDidReceiveMemoryWarning(Application application, long l2) {
        }

        public void handleWillHideAction(Application application, long l2) {
        }

        public void handleDidHideAction(Application application, long l2) {
        }

        public void handleWillUnhideAction(Application application, long l2) {
        }

        public void handleDidUnhideAction(Application application, long l2) {
        }

        public void handleOpenFilesAction(Application application, long l2, String[] arrstring) {
        }
