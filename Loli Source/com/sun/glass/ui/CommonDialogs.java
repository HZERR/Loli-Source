...
public class CommonDialogs {
    ...
    public static FileChooserResult showFileChooser(Window window, File file, String string, String string2, int n2, boolean bl, List<ExtensionFilter> list, int n3) {
        ...
        if (list == null || list.isEmpty() || n3 < 0 || n3 >= list.size()) {
            n3 = 0;
        }
        return Application.GetApplication().staticCommonDialogs_showFileChooser(window, string3, string, CommonDialogs.convertTitle(string2), n2, bl, arrextensionFilter, n3);
    }
    ...
    protected static FileChooserResult createFileChooserResult(String[] arrstring, ExtensionFilter[] arrextensionFilter, int n2) {
        ArrayList<File> arrayList = new ArrayList<File>();
        for (String string : arrstring) {
            arrayList.add(new File(string));
        }
        return new FileChooserResult(arrayList, arrextensionFilter == null || n2 < 0 || n2 >= arrextensionFilter.length ? null : arrextensionFilter[n2]);
    }
