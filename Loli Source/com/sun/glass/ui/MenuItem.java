...
public final class MenuItem {
    ...
    protected MenuItem(String string, Callback callback, int n2, int n3) {
        this(string, callback, n2, n3, null);
    }

    protected MenuItem(String string, Callback callback, int n2, int n3, Pixels pixels) {
        Application.checkEventThread();
        this.title = string;
        this.callback = callback;
        this.shortcutKey = n2;
        this.shortcutModifiers = n3;
        this.enabled = true;
        this.checked = false;
        this.delegate = PlatformFactory.getPlatformFactory().createMenuItemDelegate(this);
        if (!this.delegate.createMenuItem(string, callback, n2, n3, pixels, this.enabled, this.checked)) {
    ...
    public void setShortcut(int n2, int n3) {
        Application.checkEventThread();
        if (this.delegate.setShortcut(n2, n3)) {
            this.shortcutKey = n2;
            this.shortcutModifiers = n3;
        }
    }
