...
public abstract class Cursor {
    ...
    protected Cursor(int n2) {
        Application.checkEventThread();
        this.type = n2;
    }

    protected Cursor(int n2, int n3, Pixels pixels) {
        this(0);
        this.ptr = this._createCursor(n2, n3, pixels);
    }
    ...
    public static Size getBestSize(int n2, int n3) {
        Application.checkEventThread();
        return Application.GetApplication().staticCursor_getBestSize(n2, n3);
    }
