...
public abstract class Pixels {
    ...
    protected Pixels(int n2, int n3, IntBuffer intBuffer, float f2) {
        this.width = n2;
        this.height = n3;
        this.bytesPerComponent = 4;
        this.ints = intBuffer.slice();
    ...
    private void attachData(long l2) {
        ...
        if (this.ints != null) {
            ...
            this._attachInt(l2, this.width, this.height, this.ints, arrn, arrn != null ? this.ints.arrayOffset() : 0);
        }
        if (this.bytes != null) {
            arrn = !this.bytes.isDirect() ? this.bytes.array() : null;
            this._attachByte(l2, this.width, this.height, this.bytes, (byte[])arrn, arrn != null ? this.bytes.arrayOffset() : 0);
        }
    }
    ...
    public final int hashCode() {
        ...
        n2 = 31 * n2 + this.getHeight();
        n2 = 17 * n2 + this.asByteBuffer().hashCode();
        return n2;
    }
