...
extends Track {
    ...
    public VideoTrack(boolean bl, long l2, String string, Locale locale, Track.Encoding encoding, VideoResolution videoResolution, float f2, boolean bl2) {
