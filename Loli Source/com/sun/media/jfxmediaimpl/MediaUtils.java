...
public class MediaUtils {
     ...
     */
    public static String fileSignatureToContentType(byte[] arrby, int n2) throws MediaException {
    ...
    public static String filenameToContentType(String string) {
        ...
        if (n2 != -1) {
            String string3 = string.toLowerCase().substring(n2 + 1);
    ...
    public static void error(Object object, int n2, String string, Throwable throwable) {
        Object object2;
        Object object3;
        ...
        if (!(object3 = NativeMediaManager.getDefaultInstance().getMediaErrorListeners()).isEmpty()) {
            ...
            while (object2.hasNext()) {
                ...
                if (mediaErrorListener != null) {
                    mediaErrorListener.onError(object, n2, string);
                    continue;
                }
                object2.remove();
            }
    ...
    public static void nativeWarning(Object object, int n2, String string) {
        String string2 = String.format(NATIVE_MEDIA_WARNING_FORMAT, n2);
        if (string != null) {
