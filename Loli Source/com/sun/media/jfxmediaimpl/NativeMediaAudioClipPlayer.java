            ...
            if (schedulerEntry.getCommand() == 0) {
                ...
                try {
                    ...
                    if (null != arrnativeMediaAudioClipPlayer) {
                        for (int i2 = 0; i2 < arrnativeMediaAudioClipPlayer.length; ++i2) {
                            if (null == arrnativeMediaAudioClipPlayer[i2] || null != object && !arrnativeMediaAudioClipPlayer[i2].source().getURI().equals(object)) continue;
                            arrnativeMediaAudioClipPlayer[i2].invalidate();
                        }
                    }
                }
                finally {
