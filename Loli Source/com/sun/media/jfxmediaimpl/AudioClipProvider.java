...
public class AudioClipProvider {
    ...
    public AudioClip create(byte[] arrby, int n2, int n3, int n4, int n5, int n6) throws IllegalArgumentException {
        if (this.useNative) {
            return NativeAudioClip.create(arrby, n2, n3, n4, n5, n6);
        }
        return NativeMediaAudioClip.create(arrby, n2, n3, n4, n5, n6);
    }
