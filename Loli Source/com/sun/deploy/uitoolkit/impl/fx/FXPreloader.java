...
extends Preloader {
    ...
    FXPreloader(Applet2Context applet2Context, FXWindow fXWindow) {
        ...
        ParametersImpl.registerParameters(this.fxPreview, new ParametersImpl(map, arrstring));
    }
        ...
        public Boolean call() throws Exception {
            ...
            switch (this.pe.getType()) {
                ...
                case 3: {
                    ...
                    double d2 = (double)downloadEvent.getOverallPercentage() / 100.0;
                    FXPreloader.this.fxPreview.handleProgressNotification(new Preloader.ProgressNotification(d2));
                    return true;
                }
                case 6: {
                ...
                case 7: {
                    ...
                    return FXPreloader.this.fxPreview.handleErrorNotification(new UserDeclinedNotification(string));
                }
            }
            return false;
        }
