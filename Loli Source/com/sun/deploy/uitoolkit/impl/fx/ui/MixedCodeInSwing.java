...
public class MixedCodeInSwing {
    ...
    public static Rectangle getMouseScreenBounds() {
        ...
        for (int i2 = 0; i2 < arrgraphicsDevice.length; ++i2) {
            Rectangle rectangle = arrgraphicsDevice[i2].getDefaultConfiguration().getBounds();
            ...
            synchronized (MixedCodeInSwing.class) {
                ...
                try {
                    SwingUtilities.invokeAndWait(new Runnable(){
                        ...
                        public void run() {
                            try {
                                Object t2 = cMethod.newInstance(new Object[]{Helper.this.appInfo, null, Helper.this.title, Helper.this.masthead, false});
                                setContentMethod.invoke(t2, null, false, Helper.this.message, Helper.this.info, Helper.this.okBtnStr, Helper.this.cancelBtnStr, true, Helper.this.useWarning, Helper.this.isJsDialog, Helper.this.showAlways);
                                setVisibleMethod.invoke(t2, true);
                                Helper.this.userAnswer = (Integer)getAnswerMethod.invoke(t2, new Object[0]);
                                disposeMethod.invoke(t2, new Object[0]);
                            }
