...
extends PluginUIFactory {
    public int showMessageDialog(Object object, AppInfo appInfo, int n2, String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8) {
        switch (n2) {
            default: {
            ...
            case 0: {
                if (string4 != null) {
                    return FXUIFactory.showErrorDialog(object, appInfo, string, string3, null, string5, string6, null, FXUIFactory.getDetailPanel(string4), null);
                }
    ...
    public int showSecurityDialog(AppInfo appInfo, String string, String string2, String string3, URL uRL, boolean bl, boolean bl2, String string4, String string5, String[] arrstring, String[] arrstring2, boolean bl3, Certificate[] arrcertificate, int n2, int n3, boolean bl4) {
        return FXUIFactory.showSecurityDialog0(appInfo, string, string2, string3, uRL, bl, bl2, string4, string5, arrstring, arrstring2, bl3, arrcertificate, n2, n3, bl4, false, false, false);
    }

    public int showSecurityDialog(AppInfo appInfo, String string, String string2, String string3, URL uRL, boolean bl, boolean bl2, String string4, String string5, String[] arrstring, String[] arrstring2, boolean bl3, Certificate[] arrcertificate, int n2, int n3, boolean bl4, boolean bl5, boolean bl6) {
        return FXUIFactory.showSecurityDialog0(appInfo, string, string2, string3, uRL, bl, bl2, string4, string5, arrstring, arrstring2, bl3, arrcertificate, n2, n3, bl4, bl5, false, bl6);
    }

    public int showSandboxSecurityDialog(AppInfo appInfo, String string, String string2, String string3, URL uRL, boolean bl, boolean bl2, String string4, String string5, String[] arrstring, String[] arrstring2, boolean bl3, Certificate[] arrcertificate, int n2, int n3, boolean bl4, boolean bl5) {
        return FXUIFactory.showSecurityDialog0(appInfo, string, string2, string3, uRL, bl, bl2, string4, string5, arrstring, arrstring2, bl3, arrcertificate, n2, n3, bl4, false, true, bl5);
    }
        ...
        try {
            int n2 = FXPluginToolkit.callAndWait(new Callable<Integer>(){
                ...
                public Integer call() {
                    ...
                    int n2 = dialogTemplate.getUserAnswer();
        ...
        try {
            n4 = FXPluginToolkit.callAndWait(new Callable<Integer>(){
                ...
                public Integer call() {
                    ...
                    int n22 = arrstring3.length;
                    arrstring3 = FXUIFactory.addDetail(arrstring3, appInfo, true, true);
                    appInfo.setVendor(string3);
                    appInfo.setFrom(uRL);
                    if (bl5) {
                        dialogTemplate.setSecurityContent(bl, bl2, string4, string5, arrstring, arrstring3, n22, bl3, arrcertificate, n2, n3, bl4);
                    } else {
                        dialogTemplate.setNewSecurityContent(bl, bl2, string6, string5, arrstring, arrstring3, n22, bl3, arrcertificate, n2, n3, bl4, bl6, bl7);
                    }
                    FXUIFactory.placeWindow(dialogTemplate.getDialog());
                    dialogTemplate.setVisible(true);
                    int n32 = dialogTemplate.getUserAnswer();
                    return new Integer(n32);
                }
            });
        }
        catch (Throwable throwable) {
    ...
    private File[] showFileChooser_priv(final String string, final String[] arrstring, final int n2, final boolean bl, String string2) {
        return (File[])AccessController.doPrivileged(new PrivilegedAction(){
            ...
            public File[] run() {
                ...
                if (arrstring != null) {
                    ...
                    fileChooser.getExtensionFilters().setAll(new FileChooser.ExtensionFilter(Arrays.toString(arrstring), Arrays.asList(arrstring2)));
                }
                if (bl) {
    ...
    public File[] showFileChooser(final String string, final String[] arrstring, final int n2, final boolean bl, final String string2) {
        try {
            return FXPluginToolkit.callAndWait(new Callable<File[]>(){

                @Override
                public File[] call() {
                    return FXUIFactory.this.showFileChooser_priv(string, arrstring, n2, bl, string2);
                }
            });
        }
        catch (Throwable throwable) {
    ...
    public static Pane getDetailPanel(String string) {
        ...
        int n2 = 1;
        while (n2 + 1 < arrstring.length) {
            Label label2 = new Label();
            label2.getStyleClass().add("multiline-text");
            label2.setWrapText(true);
            label2.setText(arrstring[n2 + 1]);
            Tab tab = new Tab();
            tab.setText(arrstring[n2]);
    ...
    private static Object invokeLater(final Runnable runnable, Integer n2) throws Exception {
        if (runnable != null) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public int showSSV3Dialog(final Object object, final AppInfo appInfo, final int n2, final String string, final String string2, final String string3, final String string4, final String string5, final String string6, final String string7, final String string8, final String string9, final String string10, final String string11, final URL uRL) {
        Object object2;
        try {
            object2 = Class.forName("com.sun.deploy.config.Config", false, Thread.currentThread().getContextClassLoader());
            Method method = ((Class)object2).getDeclaredMethod("getStringProperty", String.class);
            Object object3 = method.invoke(object2, "deployment.sqe.automation.run");
            if (object3 instanceof String && "true".equals((String)object3)) {
                return 0;
            }
        }
        catch (Exception exception) {
        ...
        object2 = FXUIFactory.beforeDialog((Stage)object);
        try {
            int n3 = FXPluginToolkit.callAndWait(new Callable<Integer>(){

                @Override
                public Integer call() {
                    return FXSSV3Dialog.showSSV3Dialog(object, appInfo, n2, string, string2, string3, string4, string5, string6, string7, string8, string9, string10, string11, uRL);
                }
            });
            return n3;
        }
        ...
        try {
            int n2 = FXPluginToolkit.callAndWait(new Callable<Integer>(){
                ...
                public Integer call() {
                    ...
                    dialogTemplate.setPublisherInfo(string3, string4, string5, pane, false);
                    FXUIFactory.placeWindow(dialogTemplate.getDialog());
                    dialogTemplate.setVisible(true);
                    int n2 = dialogTemplate.getUserAnswer();
                    return new Integer(n2);
        ...
        try {
            int n2 = FXPluginToolkit.callAndWait(new Callable<Integer>(){
                ...
                public Integer call() {
                    ...
                    dialogTemplate.setBlockedDialogInfo(string3, string7, string4, string5, pane, false);
                    FXUIFactory.placeWindow(dialogTemplate.getDialog());
                    dialogTemplate.setVisible(true);
                    int n2 = dialogTemplate.getUserAnswer();
                    return new Integer(n2);
