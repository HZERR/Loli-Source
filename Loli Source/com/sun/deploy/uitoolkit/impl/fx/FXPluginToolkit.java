...
extends PluginUIToolkit {
    ...
    public boolean printApplet(Plugin2Manager plugin2Manager, int n2, Pipe pipe, long l2, boolean bl, int n3, int n4, int n5, int n6) {
        this.doInitIfNeeded();
        return false;
    }
    ...
    public UIToolkit changeMode(int n2) {
        return this;
    }
