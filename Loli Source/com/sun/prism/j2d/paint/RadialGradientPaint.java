...
extends MultipleGradientPaint {
    ...
    public RadialGradientPaint(float f2, float f3, float f4, float[] arrf, Color[] arrcolor) {
        this(f2, f3, f4, f2, f3, arrf, arrcolor, MultipleGradientPaint.CycleMethod.NO_CYCLE);
    }

    public RadialGradientPaint(Point2D point2D, float f2, float[] arrf, Color[] arrcolor) {
        this(point2D, f2, point2D, arrf, arrcolor, MultipleGradientPaint.CycleMethod.NO_CYCLE);
    }

    public RadialGradientPaint(float f2, float f3, float f4, float[] arrf, Color[] arrcolor, MultipleGradientPaint.CycleMethod cycleMethod) {
        this(f2, f3, f4, f2, f3, arrf, arrcolor, cycleMethod);
    }

    public RadialGradientPaint(Point2D point2D, float f2, float[] arrf, Color[] arrcolor, MultipleGradientPaint.CycleMethod cycleMethod) {
        this(point2D, f2, point2D, arrf, arrcolor, cycleMethod);
    }

    public RadialGradientPaint(float f2, float f3, float f4, float f5, float f6, float[] arrf, Color[] arrcolor, MultipleGradientPaint.CycleMethod cycleMethod) {
        this(new Point2D.Float(f2, f3), f4, new Point2D.Float(f5, f6), arrf, arrcolor, cycleMethod);
    }

    public RadialGradientPaint(Point2D point2D, float f2, Point2D point2D2, float[] arrf, Color[] arrcolor, MultipleGradientPaint.CycleMethod cycleMethod) {
        this(point2D, f2, point2D2, arrf, arrcolor, cycleMethod, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform());
    }

    public RadialGradientPaint(Point2D point2D, float f2, Point2D point2D2, float[] arrf, Color[] arrcolor, MultipleGradientPaint.CycleMethod cycleMethod, MultipleGradientPaint.ColorSpaceType colorSpaceType, AffineTransform affineTransform) {
