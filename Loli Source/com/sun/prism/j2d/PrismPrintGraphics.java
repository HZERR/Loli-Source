...
implements PrinterGraphics {
    ...
    public PrismPrintGraphics(Graphics2D graphics2D, int n2, int n3) {
        super(new PagePresentable(n2, n3), graphics2D);
        this.setClipRect(new Rectangle(0, 0, n2, n3));
    }
