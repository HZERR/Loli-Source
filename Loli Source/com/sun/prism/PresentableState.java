...
public abstract class PresentableState {
    ...
    private int scale(int n2, float f2, float f3) {
        return f2 == f3 ? n2 : (int)Math.ceil((float)n2 * f3 / f2);
    }
    ...
    protected void update(float f2, float f3, float f4) {
        ...
        if (f3 == f2) {
            ...
            this.renderWidth = this.scale(this.viewWidth, f2, f3);
            this.renderHeight = this.scale(this.viewHeight, f2, f3);
        }
        if (f4 == f2) {
            ...
            this.outputWidth = this.scale(this.viewWidth, f2, f4);
            this.outputHeight = this.scale(this.viewHeight, f2, f4);
        }
    }
