...
class ES2PhongShader {
    ...
    static ES2Shader getShader(ES2MeshView eS2MeshView, ES2Context eS2Context) {
        ...
        ES2Shader eS2Shader = shaders[diffuseState.ordinal()][specularState.ordinal()][selfIllumState.ordinal()][bumpMapState.ordinal()][n2];
        if (eS2Shader == null) {
            ES2Shader eS2Shader2;
            String string = lightingShaderParts[n2].replace("vec4 apply_diffuse();", diffuseShaderParts[diffuseState.ordinal()]);
            ...
            ES2PhongShader.shaders[diffuseState.ordinal()][specularState.ordinal()][selfIllumState.ordinal()][bumpMapState.ordinal()][n2] = eS2Shader2 = ES2Shader.createFromSource(eS2Context, vertexShaderSource, arrstring, hashMap2, hashMap, 1, false);
        }
        return var8_11;
    }
