...
class GLPixelFormat {
    ...
    GLPixelFormat(long l2, Attributes attributes) {
        this.nativeScreen = l2;
    ...
    void setNativePFInfo(long l2) {
        this.nativePFInfo = l2;
    }
    ...
    static class Attributes {
        ...
        void setDepthSize(int n2) {
            this.depthSize = n2;
        }

        void setAlphaSize(int n2) {
            this.alphaSize = n2;
        }

        void setBlueSize(int n2) {
            this.blueSize = n2;
        }

        void setGreenSize(int n2) {
            this.greenSize = n2;
        }

        void setRedSize(int n2) {
            this.redSize = n2;
        }
