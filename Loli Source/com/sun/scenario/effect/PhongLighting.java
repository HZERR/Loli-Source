...
extends CoreEffect<RenderState> {
    ...
    public void setDiffuseConstant(float f2) {
        if (f2 < 0.0f || f2 > 2.0f) {
            throw new IllegalArgumentException("Diffuse constant must be in the range [0,2]");
        }
        float f3 = this.diffuseConstant;
        this.diffuseConstant = f2;
    }
    ...
    public void setSpecularConstant(float f2) {
        if (f2 < 0.0f || f2 > 2.0f) {
            throw new IllegalArgumentException("Specular constant must be in the range [0,2]");
        }
        float f3 = this.specularConstant;
        this.specularConstant = f2;
    }
    ...
    public void setSpecularExponent(float f2) {
        ...
        float f3 = this.specularExponent;
