...
extends AbstractShadow {
    ...
    public GaussianShadow(float f2) {
        this(f2, Color4f.BLACK);
    }

    public GaussianShadow(float f2, Color4f color4f) {
        this(f2, color4f, DefaultInput);
    }

    public GaussianShadow(float f2, Color4f color4f, Effect effect) {
        super(effect);
    ...
    public void setHRadius(float f2) {
        float f3 = this.state.getHRadius();
        this.state.setHRadius(f2);
    }
    ...
    public void setVRadius(float f2) {
        float f3 = this.state.getVRadius();
        this.state.setVRadius(f2);
    }
    ...
    public void setGaussianWidth(float f2) {
        this.setHRadius(f2 < 1.0f ? 0.0f : (f2 - 1.0f) / 2.0f);
    }

    @Override
    public void setGaussianHeight(float f2) {
        this.setVRadius(f2 < 1.0f ? 0.0f : (f2 - 1.0f) / 2.0f);
    }
    ...
    public BaseBounds getBounds(BaseTransform baseTransform, Effect effect) {
        ...
        int n2 = this.state.getPad(0);
        int n3 = this.state.getPad(1);
