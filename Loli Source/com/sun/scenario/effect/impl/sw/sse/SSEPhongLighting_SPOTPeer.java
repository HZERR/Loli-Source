...
public class SSEPhongLighting_SPOTPeer
extends SSEEffectPeer {
    private FloatBuffer kvals;

    public SSEPhongLighting_SPOTPeer(FilterContext filterContext, Renderer renderer, String string) {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        float[] arrf5 = this.getLightPosition();
        float f3 = this.getLightSpecularExponent();
        float[] arrf6 = this.getNormalizedLightDirection();
        float f4 = this.getSpecularConstant();
        float f5 = this.getSpecularExponent();
        float f6 = this.getSurfaceScale();
        SSEPhongLighting_SPOTPeer.filter(arrn3, 0, 0, n12, n13, n14, arrn, arrf[0], arrf[1], arrf[2], arrf[3], n4, n5, n6, f2, arrf3, arrf4[0], arrf4[1], arrf4[2], arrf5[0], arrf5[1], arrf5[2], f3, arrf6[0], arrf6[1], arrf6[2], arrn2, arrf2[0], arrf2[1], arrf2[2], arrf2[3], n9, n10, n11, f4, f5, f6);
