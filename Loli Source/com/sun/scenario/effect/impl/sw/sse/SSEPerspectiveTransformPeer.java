...
extends SSEEffectPeer {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        SSEPerspectiveTransformPeer.filter(arrn2, 0, 0, n7, n8, n9, arrn, arrf[0], arrf[1], arrf[2], arrf[3], n4, n5, n6, arrf2[0], arrf2[1], arrf2[2], arrf3[0], arrf3[1], arrf3[2], arrf4[0], arrf4[1], arrf4[2]);
