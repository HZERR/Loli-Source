...
public class SSEBlend_MULTIPLYPeer
extends SSEEffectPeer {
    public SSEBlend_MULTIPLYPeer(FilterContext filterContext, Renderer renderer, String string) {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        SSEBlend_MULTIPLYPeer.filter(arrn3, 0, 0, n12, n13, n14, arrn, arrf[0], arrf[1], arrf[2], arrf[3], n4, n5, n6, f2, arrn2, arrf2[0], arrf2[1], arrf2[2], arrf2[3], n9, n10, n11);
