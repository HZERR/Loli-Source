...
extends SSEEffectPeer {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        SSEPhongLighting_POINTPeer.filter(arrn3, 0, 0, n12, n13, n14, arrn, arrf[0], arrf[1], arrf[2], arrf[3], n4, n5, n6, f2, arrf3, arrf4[0], arrf4[1], arrf4[2], arrf5[0], arrf5[1], arrf5[2], arrn2, arrf2[0], arrf2[1], arrf2[2], arrf2[3], n9, n10, n11, f3, f4, f5);
