...
extends SSEEffectPeer {
    public SSEBrightpassPeer(FilterContext filterContext, Renderer renderer, String string) {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        SSEBrightpassPeer.filter(arrn2, 0, 0, n7, n8, n9, arrn, arrf[0], arrf[1], arrf[2], arrf[3], n4, n5, n6, f2);
