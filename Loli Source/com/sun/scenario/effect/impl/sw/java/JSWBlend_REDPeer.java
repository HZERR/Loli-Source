        ...
        for (int i2 = 0; i2 < 0 + n13; ++i2) {
            ...
            for (int i3 = 0; i3 < 0 + n12; ++i3) {
                ...
                if (f14 >= 0.0f && f15 >= 0.0f) {
                    ...
                    int n19 = (int)(f15 * (float)n5);
                    boolean bl = n18 >= n4 || n19 >= n5;
                    n17 = bl ? 0 : arrn[n19 * n6 + n18];
                } else {
                    n17 = 0;
                }
                float f16 = (float)(n17 >> 16 & 0xFF) / 255.0f;
                float f17 = (float)(n17 >> 8 & 0xFF) / 255.0f;
                float f18 = (float)(n17 & 0xFF) / 255.0f;
                float f19 = (float)(n17 >>> 24) / 255.0f;
                f14 = f16;
                f15 = f17;
                float f20 = f18;
                float f21 = f19;
                ...
                if (f22 >= 0.0f && f23 >= 0.0f) {
                    ...
                    int n21 = (int)(f23 * (float)n10);
                    boolean bl = n20 >= n9 || n21 >= n10;
                    n16 = bl ? 0 : arrn2[n21 * n11 + n20];
                } else {
                    n16 = 0;
                }
                f16 = (float)(n16 >> 16 & 0xFF) / 255.0f;
                f17 = (float)(n16 >> 8 & 0xFF) / 255.0f;
                f18 = (float)(n16 & 0xFF) / 255.0f;
                f19 = (float)(n16 >>> 24) / 255.0f;
                f22 = f16 * f2;
                f23 = f17 * f2;
                float f24 = f18 * f2;
                float f25 = f19 * f2;
                ...
                float f32 = f24;
                float f33 = f25;
                float f34 = f29 + f33 - f29 * f33;
                float f35 = f27;
                float f36 = f28;
                float f37 = f12 = (1.0f - f33) * f26 + f30;
                float f38 = f35;
                float f39 = f36;
                float f40 = f34;
                float f41 = f37;
                ...
                arrn3[n15 + i3] = (int)(f41 * 255.0f) << 16 | (int)(f42 * 255.0f) << 8 | (int)(f43 * 255.0f) << 0 | (int)(f44 * 255.0f) << 24;
                f10 += f3;
                f11 += f5;
            }
            f7 += f4;
