...
public class JSWBlend_LIGHTENPeer
extends JSWEffectPeer {
    public JSWBlend_LIGHTENPeer(FilterContext filterContext, Renderer renderer, String string) {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        for (int i2 = 0; i2 < 0 + n13; ++i2) {
            ...
            for (int i3 = 0; i3 < 0 + n12; ++i3) {
                ...
                float f43 = f25 + f29 - f40;
                float f44 = f26 + f30 - f41;
                float f45 = f27 + f31 - f42;
                float f46 = f43;
                float f47 = f44;
                float f48 = f45;
                float f49 = f33;
