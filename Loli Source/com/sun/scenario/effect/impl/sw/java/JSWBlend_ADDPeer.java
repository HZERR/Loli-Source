...
public class JSWBlend_ADDPeer
extends JSWEffectPeer {
    public JSWBlend_ADDPeer(FilterContext filterContext, Renderer renderer, String string) {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        for (int i2 = 0; i2 < 0 + n13; ++i2) {
            ...
            for (int i3 = 0; i3 < 0 + n12; ++i3) {
                ...
                float f31 = f23;
                float f32 = f24;
                float f33 = f25 * f32 + f29 * f28 - f32 * f28;
                float f34 = f26 * f32 + f30 * f28 - f32 * f28;
                float f35 = f27 * f32 + f31 * f28 - f32 * f28;
                float f36 = f28 * f32 + f32 * f28 - f32 * f28;
                float f37 = 0.0f;
                float f38 = f33 > f37 ? f33 : f37;
                float f39 = f34 > f37 ? f34 : f37;
                float f40 = f35 > f37 ? f35 : f37;
                float f41 = f36 > f37 ? f36 : f37;
                f33 = f38;
                f34 = f39;
                f35 = f40;
                f36 = f41;
                float f42 = f25 + f29 - f33;
                float f43 = f26 + f30 - f34;
                float f44 = f27 + f31 - f35;
                float f45 = f28 + f32 - f36;
                float f46 = f42;
                float f47 = f43;
                float f48 = f44;
                float f49 = f45;
