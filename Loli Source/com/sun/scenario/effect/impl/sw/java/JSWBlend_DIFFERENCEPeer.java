...
public class JSWBlend_DIFFERENCEPeer
extends JSWEffectPeer {
    public JSWBlend_DIFFERENCEPeer(FilterContext filterContext, Renderer renderer, String string) {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        for (int i2 = 0; i2 < 0 + n13; ++i2) {
            ...
            for (int i3 = 0; i3 < 0 + n12; ++i3) {
                ...
                float f38 = f28 * f30;
                float f39 = f28 * f31;
                float f40 = f34 < f37 ? f34 : f37;
                float f41 = f35 < f38 ? f35 : f38;
                float f42 = f36 < f39 ? f36 : f39;
                float f43 = f25 + f29 - 2.0f * f40;
                float f44 = f26 + f30 - 2.0f * f41;
                float f45 = f27 + f31 - 2.0f * f42;
                float f46 = f43;
                float f47 = f44;
                float f48 = f45;
                float f49 = f33;
                ...
                arrn3[n15 + i3] = (int)(f50 * 255.0f) << 16 | (int)(f51 * 255.0f) << 8 | (int)(f52 * 255.0f) << 0 | (int)(f53 * 255.0f) << 24;
                f10 += f3;
                f11 += f5;
            }
            f7 += f4;
