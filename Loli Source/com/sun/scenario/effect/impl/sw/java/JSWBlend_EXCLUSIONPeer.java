...
public class JSWBlend_EXCLUSIONPeer
extends JSWEffectPeer {
    public JSWBlend_EXCLUSIONPeer(FilterContext filterContext, Renderer renderer, String string) {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        for (int i2 = 0; i2 < 0 + n13; ++i2) {
            ...
            for (int i3 = 0; i3 < 0 + n12; ++i3) {
                ...
                float f34 = f29 + f25 - 2.0f * f29 * f25;
                float f35 = f30 + f26 - 2.0f * f30 * f26;
                float f36 = f31 + f27 - 2.0f * f31 * f27;
                float f37 = f34;
                float f38 = f35;
                float f39 = f36;
                float f40 = f33;
