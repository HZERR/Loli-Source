...
extends EffectPeer {
    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        int n2 = (int)((BaseBounds)rectBounds).getMinX();
        int n3 = (int)((BaseBounds)rectBounds).getMinY();
        int n4 = (int)((BaseBounds)rectBounds).getWidth();
        int n5 = (int)((BaseBounds)rectBounds).getHeight();
        ...
        PrDrawable prDrawable = (PrDrawable)this.getRenderer().getCompatibleImage(n6, n7);
        if (prDrawable != null) {
            ...
            graphics.fillQuad(n2, n3, n2 + n4, n3 + n5);
        }
