...
public class PPSLinearConvolveShadowPeer
extends PPSOneSamplerPeer<LinearConvolveRenderState> {
    public PPSLinearConvolveShadowPeer(FilterContext filterContext, Renderer renderer, String string) {
    ...
    protected void updateShader(Shader shader) {
        ...
        shader.setConstant("shadowColor", arrf2[0], arrf2[1], arrf2[2], arrf2[3]);
    }
}
