        ...
        public Object invoke(Object proxy, final Method method, final Object[] args) throws Throwable {
            if (args != null) {
                for (int i2 = 0; i2 < args.length; ++i2) {
                    ...
                    if (args[i2] == null || !Proxy.isProxyClass(args[i2].getClass()) || !((ih = Proxy.getInvocationHandler(args[i2])) instanceof ProxyObject2)) continue;
                    args[i2] = ((ProxyObject2)ih).delegate;
                }
            }
