...
public abstract class TlbBase {
    ...
    protected boolean isReservedMethod(String method) {
        int i2;
        for (i2 = 0; i2 < IUNKNOWN_METHODS.length; ++i2) {
            if (!IUNKNOWN_METHODS[i2].equalsIgnoreCase(method)) continue;
            return true;
        }
        for (i2 = 0; i2 < IDISPATCH_METHODS.length; ++i2) {
            if (!IDISPATCH_METHODS[i2].equalsIgnoreCase(method)) continue;
            return true;
        }
        return false;
    }
