    ...
    public static ArrayList<COMInfo> getAllCOMInfoOnSystem() {
        ...
        try {
            ...
            for (int i2 = 0; i2 < infoKey.lpcSubKeys.getValue(); ++i2) {
                Advapi32Util.EnumKey enumKey = Advapi32Util.registryRegEnumKey(phkResult.getValue(), i2);
                ...
                for (int y2 = 0; y2 < infoKey2.lpcSubKeys.getValue(); ++y2) {
                    Advapi32Util.EnumKey enumKey2 = Advapi32Util.registryRegEnumKey(phkResult2.getValue(), y2);
