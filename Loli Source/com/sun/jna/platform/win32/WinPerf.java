...
public interface WinPerf {
    ...
    extends Structure {
        ...
        public PERF_COUNTER_BLOCK(Pointer p2) {
            super(p2);
            this.read();
        }
    }
    ...
    extends Structure {
        ...
        public PERF_COUNTER_DEFINITION(Pointer p2) {
            super(p2);
            this.read();
        }
    }
    ...
    extends Structure {
        ...
        public PERF_OBJECT_TYPE(Pointer p2) {
            super(p2);
            this.read();
        }
    }
    ...
    extends Structure {
        ...
        public PERF_INSTANCE_DEFINITION(Pointer p2) {
            super(p2);
            this.read();
        }
    }
    ...
    extends Structure {
        ...
        public PERF_DATA_BLOCK(Pointer p2) {
            super(p2);
            this.read();
        }
    }
