    ...
    extends WinCrypt.CRYPT_SIGN_MESSAGE_PARA {
        ...
        public void setRgpMsgCert(WinCrypt.CERT_CONTEXT[] rgpMsgCerts) {
            ...
            if (rgpMsgCerts == null || rgpMsgCerts.length == 0) {
                ...
                for (int i2 = 0; i2 < rgpMsgCerts.length; ++i2) {
                    mem.setPointer(i2 * Native.POINTER_SIZE, rgpMsgCerts[i2].getPointer());
                }
                this.rgpMsgCert = mem;
            }
        }
        ...
        public void setRgpMsgCrl(WinCrypt.CRL_CONTEXT[] rgpMsgCrls) {
            ...
            if (rgpMsgCrls == null || rgpMsgCrls.length == 0) {
                ...
                for (int i2 = 0; i2 < rgpMsgCrls.length; ++i2) {
                    mem.setPointer(i2 * Native.POINTER_SIZE, rgpMsgCrls[i2].getPointer());
                }
                this.rgpMsgCert = mem;
            }
        }
