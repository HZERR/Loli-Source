...
public interface Winevt {
    ...
    extends Structure {
        ...
        public EVT_RPC_LOGIN(String Server, String User2, String Domain, String Password, int Flags2) {
            super(W32APITypeMapper.UNICODE);
            this.Server = Server;
            this.User = User2;
            this.Domain = Domain;
                ...
                switch (type) {
                    ...
                    case EvtVarTypeBoolean: {
                        if (value.getClass().isArray() && value.getClass().getComponentType() == WinDef.BOOL.class) {
                            ...
                            for (int i2 = 0; i2 < ((WinDef.BOOL[])value).length; ++i2) {
                                mem.setInt(i2 * 4, ((WinDef.BOOL[])value)[i2].intValue());
                            }
                            this.holder = mem;
                            this.Count = 0;
                            this.field1.writeField("pointerValue", mem);
                ...
                case EvtVarTypeBoolean: {
                    if (this.isArray()) {
                        ...
                        for (int i2 = 0; i2 < result.length; ++i2) {
                            result[i2] = new WinDef.BOOL((long)rawValue[i2]);
                        }
                        return result;
                    }
                ...
                case EvtVarTypeSizeT: {
                    if (this.isArray()) {
                        ...
                        for (int i3 = 0; i3 < result.length; ++i3) {
                            result[i3] = new BaseTSD.SIZE_T(rawValue[i3]);
                        }
                        return result;
                    }
                ...
                case EvtVarTypeEvtHandle: {
                    if (this.isArray()) {
                        ...
                        for (int i4 = 0; i4 < result.length; ++i4) {
                            result[i4] = new WinNT.HANDLE(rawValue[i4]);
                        }
                        return result;
                    }
