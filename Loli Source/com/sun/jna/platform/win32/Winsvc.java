...
public interface Winsvc {
    ...
    extends WinNT.HANDLE {
        ...
        public SERVICE_STATUS_HANDLE(Pointer p2) {
            super(p2);
        }
    }
    ...
    extends ChangeServiceConfig2Info {
        ...
        public SERVICE_FAILURE_ACTIONS_FLAG(Pointer p2) {
            super(p2);
            this.read();
        }
    }
    ...
    extends ChangeServiceConfig2Info {
        ...
        public SERVICE_FAILURE_ACTIONS(Pointer p2) {
            super(p2);
            this.read();
        }
    ...
    extends Structure {
        ...
        public ChangeServiceConfig2Info(Pointer p2) {
            super(p2, 0, Boolean.getBoolean("w32.ascii") ? W32APITypeMapper.ASCII : W32APITypeMapper.UNICODE);
        }
    }
