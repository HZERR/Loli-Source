...
public abstract class DdemlUtil {
    ...
    implements InvocationHandler {
        ...
        private <V> V wrap(V delegate, Class clazz) {
            ...
            Class[] arrclass = new Class[]{clazz};
            User32Util.MessageLoopThread messageLoopThread = this.loopThread;
            messageLoopThread.getClass();
            Object messageLoopHandler = Proxy.newProxyInstance(classLoader, arrclass, new User32Util.MessageLoopThread.Handler(messageLoopThread, delegate));
    ...
    Closeable {
        ...
        public StandaloneDdeClient() {
            ClassLoader classLoader = StandaloneDdeClient.class.getClassLoader();
            Class[] arrclass = new Class[]{IDdeClient.class};
            User32Util.MessageLoopThread messageLoopThread = this.messageLoop;
            messageLoopThread.getClass();
            IDdeClient messageLoopHandler = (IDdeClient)Proxy.newProxyInstance(classLoader, arrclass, new User32Util.MessageLoopThread.Handler(messageLoopThread, this.ddeClient));
