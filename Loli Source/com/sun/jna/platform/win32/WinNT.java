...
BaseTSD {
    ...
    public static final class LocaleMacros {
        ...
        public static final int MAKELANGID(int p2, int s2) {
            return s2 << 10 | p2 & 0xFFFF;
        }
    ...
    extends Structure {
        ...
        public SYSTEM_POWER_CAPABILITIES(Pointer p2) {
            super(p2);
            this.read();
        }
    ...
    extends Structure {
        ...
        public SYSTEM_POWER_POLICY(Pointer p2) {
            super(p2);
            this.read();
        }
    ...
    extends Structure {
        ...
        public SYSTEM_POWER_INFORMATION(Pointer p2) {
            super(p2);
            this.read();
        }
    ...
    extends Structure {
        ...
        public PROCESSOR_POWER_INFORMATION(Pointer p2) {
            super(p2);
            this.read();
        }
    ...
    extends Structure {
        ...
        public SYSTEM_BATTERY_STATE(Pointer p2) {
            super(p2);
            this.read();
        }
    ...
    extends Structure {
        ...
        public SECURITY_DESCRIPTOR_RELATIVE(Pointer p2) {
            super(p2);
            this.setMembers();
        }
    ...
    extends ByReference {
        ...
        public PACLByReference(ACL h2) {
            super(Native.POINTER_SIZE);
            this.setValue(h2);
        }

        public void setValue(ACL h2) {
    ...
    extends Structure {
        ...
        public ACE_HEADER[] getACEs() {
            ...
            for (int i2 = 0; i2 < this.AceCount; ++i2) {
                ...
                switch (aceType) {
                    case 0: {
                        ACEs[i2] = new ACCESS_ALLOWED_ACE(share);
                        break;
                    }
                    case 1: {
                        ACEs[i2] = new ACCESS_DENIED_ACE(share);
                        break;
                    }
                    default: {
                        ACEs[i2] = new ACE_HEADER(share);
                    }
                }
                offset += ACEs[i2].AceSize;
            }
            return ACEs;
        }
    }
    ...
    extends Structure {
        ...
        public TOKEN_PRIVILEGES(Pointer p2) {
            super(p2);
            int count = p2.getInt(0L);
    ...
    extends Structure {
        ...
        public PRIVILEGE_SET(Pointer p2) {
            super(p2);
            int count = p2.getInt(0L);
            this.PrivilegeCount = new WinDef.DWORD((long)count);
            if (count > 0) {
