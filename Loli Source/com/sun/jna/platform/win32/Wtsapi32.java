...
extends StdCallLibrary {
    ...
    extends Structure {
        ...
        public WTS_PROCESS_INFO_EX(Pointer p2) {
            super(p2, 0, W32APITypeMapper.DEFAULT);
            this.read();
        }
    }
    ...
    extends Structure {
        ...
        public WTS_CLIENT_ADDRESS(Pointer p2) {
            super(p2);
            this.read();
        }
    }
    ...
    extends Structure {
        ...
        public WTS_SESSION_INFO(Pointer p2) {
            super(p2, 0, W32APITypeMapper.DEFAULT);
            this.read();
        }
    }
