...
public interface WinCrypt {
    ...
    extends WinNT.HANDLE {
        ...
        public HCERTCHAINENGINE(Pointer p2) {
            super(p2);
        }
    }
    ...
    extends Structure {
        ...
        public CERT_CONTEXT[] getRgpMsgCert() {
            ...
            for (int i2 = 0; i2 < elements.length; ++i2) {
                elements[i2] = Structure.newInstance(CERT_CONTEXT.class, this.rgpMsgCert.getPointer(i2 * Native.POINTER_SIZE));
                elements[i2].read();
            }
            return elements;
        }
        ...
        public CRL_CONTEXT[] getRgpMsgCrl() {
            ...
            for (int i2 = 0; i2 < elements.length; ++i2) {
                elements[i2] = Structure.newInstance(CRL_CONTEXT.class, this.rgpMsgCrl.getPointer(i2 * Native.POINTER_SIZE));
                elements[i2].read();
            }
            return elements;
        }
    ...
    extends Structure {
        ...
        public CRYPT_KEY_PROV_PARAM[] getRgProvParam() {
            ...
            for (int i2 = 0; i2 < elements.length; ++i2) {
                elements[i2] = Structure.newInstance(CRYPT_KEY_PROV_PARAM.class, this.rgProvParam.getPointer(i2 * Native.POINTER_SIZE));
                elements[i2].read();
            }
            return elements;
        }
    ...
    extends Structure {
        ...
        public CERT_SIMPLE_CHAIN[] getRgpChain() {
            ...
            for (int i2 = 0; i2 < elements.length; ++i2) {
                elements[i2] = Structure.newInstance(CERT_SIMPLE_CHAIN.class, this.rgpChain.getPointer(i2 * Native.POINTER_SIZE));
                elements[i2].read();
            }
            return elements;
        }
        ...
        public CERT_CHAIN_CONTEXT[] getRgpLowerQualityChainContext() {
            ...
            for (int i2 = 0; i2 < elements.length; ++i2) {
                elements[i2] = Structure.newInstance(CERT_CHAIN_CONTEXT.class, this.rgpLowerQualityChainContext.getPointer(i2 * Native.POINTER_SIZE));
                elements[i2].read();
            }
            return elements;
        }
    ...
    extends Structure {
        ...
        public CERT_CHAIN_ELEMENT[] getRgpElement() {
            ...
            for (int i2 = 0; i2 < elements.length; ++i2) {
                elements[i2] = Structure.newInstance(CERT_CHAIN_ELEMENT.class, this.rgpElement.getPointer(i2 * Native.POINTER_SIZE));
                elements[i2].read();
            }
            return elements;
        }
    ...
    extends Structure {
        ...
        public CERT_CHAIN_ELEMENT(Pointer p2) {
            super(p2, 0, W32APITypeMapper.UNICODE);
        }
