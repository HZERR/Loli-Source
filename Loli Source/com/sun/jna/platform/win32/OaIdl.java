...
public interface OaIdl {
    ...
    implements Structure.ByReference {
        ...
        public SAFEARRAYByReference(Pointer p2) {
            super(p2);
            this.read();
        }
    ...
    implements Closeable {
        ...
        public static ByReference createSafeArray(WTypes.VARTYPE vartype, int ... size) {
            ...
            for (int i2 = 0; i2 < size.length; ++i2) {
                rgsabound[i2].lLbound = new WinDef.LONG(0L);
                rgsabound[i2].cElements = new WinDef.ULONG((long)size[size.length - i2 - 1]);
            }
        ...
        public void putElement(Object arg, int ... indices) {
            ...
            for (int i2 = 0; i2 < indices.length; ++i2) {
                paramIndices[i2] = new WinDef.LONG((long)indices[indices.length - i2 - 1]);
            }
