...
DragGestureListener {
    ...
    public static Transferable getTransferable(DropTargetEvent e2) {
        if (e2 instanceof DropTargetDragEvent) {
            try {
                return ((DropTargetDragEvent)e2).getTransferable();
            }
    ...
    private void describe(String type, DragSourceEvent e2) {
        if (LOG.isLoggable(Level.FINE)) {
            ...
            DragSourceContext ds = e2.getDragSourceContext();
            if (e2 instanceof DragSourceDragEvent) {
                DragSourceDragEvent ev = (DragSourceDragEvent)e2;
