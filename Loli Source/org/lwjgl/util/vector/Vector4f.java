...
WritableVector4f {
    ...
    public Vector4f(float x2, float y2, float z, float w2) {
        this.set(x2, y2, z, w2);
    }
    ...
    public void set(float x2, float y2, float z) {
        this.x = x2;
        this.y = y2;
        this.z = z;
    }

    public void set(float x2, float y2, float z, float w2) {
        this.x = x2;
        this.y = y2;
        this.z = z;
        this.w = w2;
    ...
    public Vector4f translate(float x2, float y2, float z, float w2) {
        this.x += x2;
        this.y += y2;
        this.z += z;
        this.w += w2;
