        ...
        if (this.drawStyle == 100012) {
            ...
            if (!this.textureFlag) {
                ...
                for (j2 = 0; j2 <= slices; ++j2) {
                    ...
                    if (normals) {
                        GL11.glNormal3f(x2 * nsign, y2 * nsign, z * nsign);
                    }
                    GL11.glVertex3f(x2 * radius, y2 * radius, z * radius);
                }
                GL11.glEnd();
            }
            ...
            for (i3 = 1; i3 < stacks; ++i3) {
                ...
                for (j3 = 0; j3 < slices; ++j3) {
                    ...
                    z = this.cos(rho);
                    if (normals) {
                        GL11.glNormal3f(x3 * nsign, y3 * nsign, z * nsign);
                    }
                    GL11.glVertex3f(x3 * radius, y3 * radius, z * radius);
                }
                GL11.glEnd();
            }
            for (j3 = 0; j3 < slices; ++j3) {
            ...
            for (int i4 = 1; i4 < stacks - 1; ++i4) {
                ...
                for (int j4 = 0; j4 < slices; ++j4) {
                    ...
                    if (normals) {
                        GL11.glNormal3f(x4 * nsign, y4 * nsign, z * nsign);
                    }
                    GL11.glVertex3f(x4 * radius, y4 * radius, z * radius);
                }
            }
            GL11.glEnd();
        }
