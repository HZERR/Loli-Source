...
public final class NVVertexAttribInteger64bit {
    ...
    public static void glVertexAttribL3i64NV(int index, long x2, long y2, long z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL3i64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexAttribInteger64bit.nglVertexAttribL3i64NV(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttribL3i64NV(int var0, long var1, long var3, long var5, long var7);

    public static void glVertexAttribL4i64NV(int index, long x2, long y2, long z, long w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL4i64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexAttribInteger64bit.nglVertexAttribL4i64NV(index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glVertexAttribL1NV(int index, LongBuffer v2) {
        ...
        NVVertexAttribInteger64bit.nglVertexAttribL1i64vNV(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL2NV(int index, LongBuffer v2) {
        ...
        NVVertexAttribInteger64bit.nglVertexAttribL2i64vNV(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL3NV(int index, LongBuffer v2) {
        ...
        NVVertexAttribInteger64bit.nglVertexAttribL3i64vNV(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL4NV(int index, LongBuffer v2) {
        ...
        NVVertexAttribInteger64bit.nglVertexAttribL4i64vNV(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL3ui64NV(int index, long x2, long y2, long z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL3ui64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexAttribInteger64bit.nglVertexAttribL3ui64NV(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttribL3ui64NV(int var0, long var1, long var3, long var5, long var7);

    public static void glVertexAttribL4ui64NV(int index, long x2, long y2, long z, long w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL4ui64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexAttribInteger64bit.nglVertexAttribL4ui64NV(index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glVertexAttribL1uNV(int index, LongBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 1);
        NVVertexAttribInteger64bit.nglVertexAttribL1ui64vNV(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL2uNV(int index, LongBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 2);
        NVVertexAttribInteger64bit.nglVertexAttribL2ui64vNV(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL3uNV(int index, LongBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 3);
        NVVertexAttribInteger64bit.nglVertexAttribL3ui64vNV(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL4uNV(int index, LongBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 4);
        NVVertexAttribInteger64bit.nglVertexAttribL4ui64vNV(index, MemoryUtil.getAddress(v2), function_pointer);
    }
