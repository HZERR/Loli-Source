...
public final class GL20 {
    ...
    public static void glVertexAttrib3s(int index, short x2, short y2, short z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib3s;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib3s(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttrib3s(int var0, short var1, short var2, short var3, long var4);

    public static void glVertexAttrib3f(int index, float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib3f;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib3f(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttrib3f(int var0, float var1, float var2, float var3, long var4);

    public static void glVertexAttrib3d(int index, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib3d;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib3d(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttrib3d(int var0, double var1, double var3, double var5, long var7);

    public static void glVertexAttrib4s(int index, short x2, short y2, short z, short w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4s;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib4s(index, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexAttrib4s(int var0, short var1, short var2, short var3, short var4, long var5);

    public static void glVertexAttrib4f(int index, float x2, float y2, float z, float w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4f;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib4f(index, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexAttrib4f(int var0, float var1, float var2, float var3, float var4, long var5);

    public static void glVertexAttrib4d(int index, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4d;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib4d(index, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexAttrib4d(int var0, double var1, double var3, double var5, double var7, long var9);

    public static void glVertexAttrib4Nub(int index, byte x2, byte y2, byte z, byte w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4Nub;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL20.nglVertexAttrib4Nub(index, x2, y2, z, w2, function_pointer);
    }
