...
public final class GL30 {
    ...
    public static void glVertexAttribI3i(int index, int x2, int y2, int z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribI3i;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI3i(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttribI3i(int var0, int var1, int var2, int var3, long var4);

    public static void glVertexAttribI4i(int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribI4i;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI4i(index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glVertexAttribI3ui(int index, int x2, int y2, int z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribI3ui;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI3ui(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttribI3ui(int var0, int var1, int var2, int var3, long var4);

    public static void glVertexAttribI4ui(int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribI4ui;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglVertexAttribI4ui(index, x2, y2, z, w2, function_pointer);
    }
