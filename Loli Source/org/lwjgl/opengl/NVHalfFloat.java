...
public final class NVHalfFloat {
    ...
    public static void glVertex3hNV(short x2, short y2, short z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertex3hNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVHalfFloat.nglVertex3hNV(x2, y2, z, function_pointer);
    }

    static native void nglVertex3hNV(short var0, short var1, short var2, long var3);

    public static void glVertex4hNV(short x2, short y2, short z, short w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertex4hNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVHalfFloat.nglVertex4hNV(x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glVertexAttrib3hNV(int index, short x2, short y2, short z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib3hNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVHalfFloat.nglVertexAttrib3hNV(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttrib3hNV(int var0, short var1, short var2, short var3, long var4);

    public static void glVertexAttrib4hNV(int index, short x2, short y2, short z, short w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4hNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVHalfFloat.nglVertexAttrib4hNV(index, x2, y2, z, w2, function_pointer);
    }
