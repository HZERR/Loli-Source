...
public final class ARBWindowPos {
    ...
    public static void glWindowPos3fARB(float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glWindowPos3fARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBWindowPos.nglWindowPos3fARB(x2, y2, z, function_pointer);
    }

    static native void nglWindowPos3fARB(float var0, float var1, float var2, long var3);

    public static void glWindowPos3dARB(double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glWindowPos3dARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBWindowPos.nglWindowPos3dARB(x2, y2, z, function_pointer);
    }

    static native void nglWindowPos3dARB(double var0, double var2, double var4, long var6);

    public static void glWindowPos3iARB(int x2, int y2, int z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glWindowPos3iARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBWindowPos.nglWindowPos3iARB(x2, y2, z, function_pointer);
    }

    static native void nglWindowPos3iARB(int var0, int var1, int var2, long var3);

    public static void glWindowPos3sARB(short x2, short y2, short z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glWindowPos3sARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBWindowPos.nglWindowPos3sARB(x2, y2, z, function_pointer);
    }
