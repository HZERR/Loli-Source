...
public final class GL14 {
    ...
    public static void glWindowPos3f(float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glWindowPos3f;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos3f(x2, y2, z, function_pointer);
    }

    static native void nglWindowPos3f(float var0, float var1, float var2, long var3);

    public static void glWindowPos3d(double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glWindowPos3d;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos3d(x2, y2, z, function_pointer);
    }

    static native void nglWindowPos3d(double var0, double var2, double var4, long var6);

    public static void glWindowPos3i(int x2, int y2, int z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glWindowPos3i;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL14.nglWindowPos3i(x2, y2, z, function_pointer);
    }
