...
public final class EXTDirectStateAccess {
    ...
    public static void glMatrixLoadEXT(int matrixMode, FloatBuffer m2) {
        ...
        EXTDirectStateAccess.nglMatrixLoadfEXT(matrixMode, MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMatrixLoadEXT(int matrixMode, DoubleBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        EXTDirectStateAccess.nglMatrixLoaddEXT(matrixMode, MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMatrixMultEXT(int matrixMode, FloatBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        EXTDirectStateAccess.nglMatrixMultfEXT(matrixMode, MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMatrixMultEXT(int matrixMode, DoubleBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        EXTDirectStateAccess.nglMatrixMultdEXT(matrixMode, MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMatrixRotatefEXT(int matrixMode, float angle, float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMatrixRotatefEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglMatrixRotatefEXT(matrixMode, angle, x2, y2, z, function_pointer);
    }

    static native void nglMatrixRotatefEXT(int var0, float var1, float var2, float var3, float var4, long var5);

    public static void glMatrixRotatedEXT(int matrixMode, double angle, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMatrixRotatedEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglMatrixRotatedEXT(matrixMode, angle, x2, y2, z, function_pointer);
    }

    static native void nglMatrixRotatedEXT(int var0, double var1, double var3, double var5, double var7, long var9);

    public static void glMatrixScalefEXT(int matrixMode, float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMatrixScalefEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglMatrixScalefEXT(matrixMode, x2, y2, z, function_pointer);
    }

    static native void nglMatrixScalefEXT(int var0, float var1, float var2, float var3, long var4);

    public static void glMatrixScaledEXT(int matrixMode, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMatrixScaledEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglMatrixScaledEXT(matrixMode, x2, y2, z, function_pointer);
    }

    static native void nglMatrixScaledEXT(int var0, double var1, double var3, double var5, long var7);

    public static void glMatrixTranslatefEXT(int matrixMode, float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMatrixTranslatefEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglMatrixTranslatefEXT(matrixMode, x2, y2, z, function_pointer);
    }

    static native void nglMatrixTranslatefEXT(int var0, float var1, float var2, float var3, long var4);

    public static void glMatrixTranslatedEXT(int matrixMode, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMatrixTranslatedEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglMatrixTranslatedEXT(matrixMode, x2, y2, z, function_pointer);
    }
    ...
    public static void glNamedProgramLocalParameter4dEXT(int program, int target, int index, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNamedProgramLocalParameter4dEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglNamedProgramLocalParameter4dEXT(program, target, index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glNamedProgramLocalParameter4fEXT(int program, int target, int index, float x2, float y2, float z, float w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNamedProgramLocalParameter4fEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglNamedProgramLocalParameter4fEXT(program, target, index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glMatrixLoadTransposeEXT(int matrixMode, FloatBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        EXTDirectStateAccess.nglMatrixLoadTransposefEXT(matrixMode, MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMatrixLoadTransposeEXT(int matrixMode, DoubleBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        EXTDirectStateAccess.nglMatrixLoadTransposedEXT(matrixMode, MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMatrixMultTransposeEXT(int matrixMode, FloatBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        EXTDirectStateAccess.nglMatrixMultTransposefEXT(matrixMode, MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMatrixMultTransposeEXT(int matrixMode, DoubleBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        EXTDirectStateAccess.nglMatrixMultTransposedEXT(matrixMode, MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glNamedProgramLocalParameterI4iEXT(int program, int target, int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNamedProgramLocalParameterI4iEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglNamedProgramLocalParameterI4iEXT(program, target, index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glNamedProgramLocalParameterI4uiEXT(int program, int target, int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNamedProgramLocalParameterI4uiEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDirectStateAccess.nglNamedProgramLocalParameterI4uiEXT(program, target, index, x2, y2, z, w2, function_pointer);
    }
