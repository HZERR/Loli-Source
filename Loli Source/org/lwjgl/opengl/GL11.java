...
public final class GL11 {
    ...
    public static void glScalef(float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glScalef;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglScalef(x2, y2, z, function_pointer);
    }

    static native void nglScalef(float var0, float var1, float var2, long var3);

    public static void glScaled(double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glScaled;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglScaled(x2, y2, z, function_pointer);
    }

    static native void nglScaled(double var0, double var2, double var4, long var6);

    public static void glRotatef(float angle, float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glRotatef;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglRotatef(angle, x2, y2, z, function_pointer);
    }

    static native void nglRotatef(float var0, float var1, float var2, float var3, long var4);

    public static void glRotated(double angle, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glRotated;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglRotated(angle, x2, y2, z, function_pointer);
    }
