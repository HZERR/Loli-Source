...
public final class ARBViewportArray {
    ...
    public static void glGetIntegerIndexedEXT(int target, int index, IntBuffer v2) {
        EXTDrawBuffers2.glGetIntegerIndexedEXT(target, index, v2);
    }
