...
public final class NVGpuShader5 {
    ...
    public static void glUniform3i64NV(int location, long x2, long y2, long z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glUniform3i64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform3i64NV(location, x2, y2, z, function_pointer);
    }

    static native void nglUniform3i64NV(int var0, long var1, long var3, long var5, long var7);

    public static void glUniform4i64NV(int location, long x2, long y2, long z, long w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glUniform4i64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform4i64NV(location, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glUniform3ui64NV(int location, long x2, long y2, long z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glUniform3ui64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform3ui64NV(location, x2, y2, z, function_pointer);
    }

    static native void nglUniform3ui64NV(int var0, long var1, long var3, long var5, long var7);

    public static void glUniform4ui64NV(int location, long x2, long y2, long z, long w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glUniform4ui64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglUniform4ui64NV(location, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glProgramUniform3i64NV(int program, int location, long x2, long y2, long z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramUniform3i64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform3i64NV(program, location, x2, y2, z, function_pointer);
    }

    static native void nglProgramUniform3i64NV(int var0, int var1, long var2, long var4, long var6, long var8);

    public static void glProgramUniform4i64NV(int program, int location, long x2, long y2, long z, long w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramUniform4i64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform4i64NV(program, location, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glProgramUniform3ui64NV(int program, int location, long x2, long y2, long z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramUniform3ui64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform3ui64NV(program, location, x2, y2, z, function_pointer);
    }

    static native void nglProgramUniform3ui64NV(int var0, int var1, long var2, long var4, long var6, long var8);

    public static void glProgramUniform4ui64NV(int program, int location, long x2, long y2, long z, long w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramUniform4ui64NV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuShader5.nglProgramUniform4ui64NV(program, location, x2, y2, z, w2, function_pointer);
    }
