...
public final class ATIVertexStreams {
    ...
    public static void glVertexStream3fATI(int stream, float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexStream3fATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglVertexStream3fATI(stream, x2, y2, z, function_pointer);
    }

    static native void nglVertexStream3fATI(int var0, float var1, float var2, float var3, long var4);

    public static void glVertexStream3dATI(int stream, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexStream3dATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglVertexStream3dATI(stream, x2, y2, z, function_pointer);
    }

    static native void nglVertexStream3dATI(int var0, double var1, double var3, double var5, long var7);

    public static void glVertexStream3iATI(int stream, int x2, int y2, int z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexStream3iATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglVertexStream3iATI(stream, x2, y2, z, function_pointer);
    }

    static native void nglVertexStream3iATI(int var0, int var1, int var2, int var3, long var4);

    public static void glVertexStream3sATI(int stream, short x2, short y2, short z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexStream3sATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglVertexStream3sATI(stream, x2, y2, z, function_pointer);
    }

    static native void nglVertexStream3sATI(int var0, short var1, short var2, short var3, long var4);

    public static void glVertexStream4fATI(int stream, float x2, float y2, float z, float w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexStream4fATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglVertexStream4fATI(stream, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexStream4fATI(int var0, float var1, float var2, float var3, float var4, long var5);

    public static void glVertexStream4dATI(int stream, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexStream4dATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglVertexStream4dATI(stream, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexStream4dATI(int var0, double var1, double var3, double var5, double var7, long var9);

    public static void glVertexStream4iATI(int stream, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexStream4iATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglVertexStream4iATI(stream, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexStream4iATI(int var0, int var1, int var2, int var3, int var4, long var5);

    public static void glVertexStream4sATI(int stream, short x2, short y2, short z, short w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexStream4sATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglVertexStream4sATI(stream, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexStream4sATI(int var0, short var1, short var2, short var3, short var4, long var5);

    public static void glNormalStream3bATI(int stream, byte x2, byte y2, byte z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormalStream3bATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglNormalStream3bATI(stream, x2, y2, z, function_pointer);
    }

    static native void nglNormalStream3bATI(int var0, byte var1, byte var2, byte var3, long var4);

    public static void glNormalStream3fATI(int stream, float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormalStream3fATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglNormalStream3fATI(stream, x2, y2, z, function_pointer);
    }

    static native void nglNormalStream3fATI(int var0, float var1, float var2, float var3, long var4);

    public static void glNormalStream3dATI(int stream, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormalStream3dATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglNormalStream3dATI(stream, x2, y2, z, function_pointer);
    }

    static native void nglNormalStream3dATI(int var0, double var1, double var3, double var5, long var7);

    public static void glNormalStream3iATI(int stream, int x2, int y2, int z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormalStream3iATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglNormalStream3iATI(stream, x2, y2, z, function_pointer);
    }

    static native void nglNormalStream3iATI(int var0, int var1, int var2, int var3, long var4);

    public static void glNormalStream3sATI(int stream, short x2, short y2, short z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormalStream3sATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexStreams.nglNormalStream3sATI(stream, x2, y2, z, function_pointer);
    }
