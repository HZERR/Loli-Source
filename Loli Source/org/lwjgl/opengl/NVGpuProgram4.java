...
public final class NVGpuProgram4 {
    ...
    public static void glProgramLocalParameterI4iNV(int target, int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramLocalParameterI4iNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuProgram4.nglProgramLocalParameterI4iNV(target, index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glProgramLocalParameterI4uiNV(int target, int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramLocalParameterI4uiNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuProgram4.nglProgramLocalParameterI4uiNV(target, index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glProgramEnvParameterI4iNV(int target, int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramEnvParameterI4iNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuProgram4.nglProgramEnvParameterI4iNV(target, index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glProgramEnvParameterI4uiNV(int target, int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramEnvParameterI4uiNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVGpuProgram4.nglProgramEnvParameterI4uiNV(target, index, x2, y2, z, w2, function_pointer);
    }
