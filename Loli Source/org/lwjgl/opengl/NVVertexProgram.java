...
extends NVProgram {
    ...
    public static void glProgramParameter4fNV(int target, int index, float x2, float y2, float z, float w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramParameter4fNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglProgramParameter4fNV(target, index, x2, y2, z, w2, function_pointer);
    }

    static native void nglProgramParameter4fNV(int var0, int var1, float var2, float var3, float var4, float var5, long var6);

    public static void glProgramParameter4dNV(int target, int index, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramParameter4dNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglProgramParameter4dNV(target, index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glVertexAttrib3sNV(int index, short x2, short y2, short z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib3sNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglVertexAttrib3sNV(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttrib3sNV(int var0, short var1, short var2, short var3, long var4);

    public static void glVertexAttrib3fNV(int index, float x2, float y2, float z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib3fNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglVertexAttrib3fNV(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttrib3fNV(int var0, float var1, float var2, float var3, long var4);

    public static void glVertexAttrib3dNV(int index, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib3dNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglVertexAttrib3dNV(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttrib3dNV(int var0, double var1, double var3, double var5, long var7);

    public static void glVertexAttrib4sNV(int index, short x2, short y2, short z, short w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4sNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglVertexAttrib4sNV(index, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexAttrib4sNV(int var0, short var1, short var2, short var3, short var4, long var5);

    public static void glVertexAttrib4fNV(int index, float x2, float y2, float z, float w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4fNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglVertexAttrib4fNV(index, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexAttrib4fNV(int var0, float var1, float var2, float var3, float var4, long var5);

    public static void glVertexAttrib4dNV(int index, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4dNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglVertexAttrib4dNV(index, x2, y2, z, w2, function_pointer);
    }

    static native void nglVertexAttrib4dNV(int var0, double var1, double var3, double var5, double var7, long var9);

    public static void glVertexAttrib4ubNV(int index, byte x2, byte y2, byte z, byte w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttrib4ubNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexProgram.nglVertexAttrib4ubNV(index, x2, y2, z, w2, function_pointer);
    }
