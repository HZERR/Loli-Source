...
public final class GL13 {
    ...
    public static void glLoadTransposeMatrix(FloatBuffer m2) {
        ...
        GL13.nglLoadTransposeMatrixf(MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glLoadTransposeMatrix(DoubleBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        GL13.nglLoadTransposeMatrixd(MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMultTransposeMatrix(FloatBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        GL13.nglMultTransposeMatrixf(MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMultTransposeMatrix(DoubleBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        GL13.nglMultTransposeMatrixd(MemoryUtil.getAddress(m2), function_pointer);
    }
