...
public final class ARBDirectStateAccess {
    ...
    public static void glInvalidateNamedFramebufferSubData(int framebuffer, IntBuffer attachments, int x2, int y2, int width, int height) {
        GL45.glInvalidateNamedFramebufferSubData(framebuffer, attachments, x2, y2, width, height);
    }
    ...
    public static void glCopyTextureSubImage1D(int texture, int level, int xoffset, int x2, int y2, int width) {
        GL45.glCopyTextureSubImage1D(texture, level, xoffset, x2, y2, width);
    }
    ...
    public static void glCopyTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int x2, int y2, int width, int height) {
        GL45.glCopyTextureSubImage2D(texture, level, xoffset, yoffset, x2, y2, width, height);
    }
    ...
    public static void glCopyTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int x2, int y2, int width, int height) {
        GL45.glCopyTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, x2, y2, width, height);
    }
