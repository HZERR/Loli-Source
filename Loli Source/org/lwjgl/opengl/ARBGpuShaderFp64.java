...
public final class ARBGpuShaderFp64 {
    ...
    public static void glUniform1d(int location, double x2) {
        GL40.glUniform1d(location, x2);
    }

    public static void glUniform2d(int location, double x2, double y2) {
        GL40.glUniform2d(location, x2, y2);
    }

    public static void glUniform3d(int location, double x2, double y2, double z) {
        GL40.glUniform3d(location, x2, y2, z);
    }

    public static void glUniform4d(int location, double x2, double y2, double z, double w2) {
        GL40.glUniform4d(location, x2, y2, z, w2);
    }
    ...
    public static void glProgramUniform3dEXT(int program, int location, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramUniform3dEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBGpuShaderFp64.nglProgramUniform3dEXT(program, location, x2, y2, z, function_pointer);
    }

    static native void nglProgramUniform3dEXT(int var0, int var1, double var2, double var4, double var6, long var8);

    public static void glProgramUniform4dEXT(int program, int location, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramUniform4dEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBGpuShaderFp64.nglProgramUniform4dEXT(program, location, x2, y2, z, w2, function_pointer);
    }
