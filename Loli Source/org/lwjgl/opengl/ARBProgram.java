...
public class ARBProgram {
    ...
    public static void glProgramEnvParameter4fARB(int target, int index, float x2, float y2, float z, float w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramEnvParameter4fARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBProgram.nglProgramEnvParameter4fARB(target, index, x2, y2, z, w2, function_pointer);
    }

    static native void nglProgramEnvParameter4fARB(int var0, int var1, float var2, float var3, float var4, float var5, long var6);

    public static void glProgramEnvParameter4dARB(int target, int index, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramEnvParameter4dARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBProgram.nglProgramEnvParameter4dARB(target, index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glProgramLocalParameter4fARB(int target, int index, float x2, float y2, float z, float w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramLocalParameter4fARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBProgram.nglProgramLocalParameter4fARB(target, index, x2, y2, z, w2, function_pointer);
    }

    static native void nglProgramLocalParameter4fARB(int var0, int var1, float var2, float var3, float var4, float var5, long var6);

    public static void glProgramLocalParameter4dARB(int target, int index, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramLocalParameter4dARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBProgram.nglProgramLocalParameter4dARB(target, index, x2, y2, z, w2, function_pointer);
    }
