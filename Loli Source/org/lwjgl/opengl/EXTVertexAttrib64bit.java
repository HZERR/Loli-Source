...
public final class EXTVertexAttrib64bit {
    ...
    public static void glVertexAttribL3dEXT(int index, double x2, double y2, double z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL3dEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexAttrib64bit.nglVertexAttribL3dEXT(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttribL3dEXT(int var0, double var1, double var3, double var5, long var7);

    public static void glVertexAttribL4dEXT(int index, double x2, double y2, double z, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL4dEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTVertexAttrib64bit.nglVertexAttribL4dEXT(index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glVertexAttribL1EXT(int index, DoubleBuffer v2) {
        ...
        EXTVertexAttrib64bit.nglVertexAttribL1dvEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL2EXT(int index, DoubleBuffer v2) {
        ...
        EXTVertexAttrib64bit.nglVertexAttribL2dvEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL3EXT(int index, DoubleBuffer v2) {
        ...
        EXTVertexAttrib64bit.nglVertexAttribL3dvEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribL4EXT(int index, DoubleBuffer v2) {
        ...
        EXTVertexAttrib64bit.nglVertexAttribL4dvEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
