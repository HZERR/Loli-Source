...
public final class EXTGpuShader4 {
    ...
    public static void glVertexAttribI3iEXT(int index, int x2, int y2, int z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribI3iEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI3iEXT(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttribI3iEXT(int var0, int var1, int var2, int var3, long var4);

    public static void glVertexAttribI4iEXT(int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribI4iEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI4iEXT(index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glVertexAttribI3uiEXT(int index, int x2, int y2, int z) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribI3uiEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI3uiEXT(index, x2, y2, z, function_pointer);
    }

    static native void nglVertexAttribI3uiEXT(int var0, int var1, int var2, int var3, long var4);

    public static void glVertexAttribI4uiEXT(int index, int x2, int y2, int z, int w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribI4uiEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTGpuShader4.nglVertexAttribI4uiEXT(index, x2, y2, z, w2, function_pointer);
    }
    ...
    public static void glVertexAttribI1EXT(int index, IntBuffer v2) {
        ...
        EXTGpuShader4.nglVertexAttribI1ivEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI2EXT(int index, IntBuffer v2) {
        ...
        EXTGpuShader4.nglVertexAttribI2ivEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI3EXT(int index, IntBuffer v2) {
        ...
        EXTGpuShader4.nglVertexAttribI3ivEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI4EXT(int index, IntBuffer v2) {
        ...
        EXTGpuShader4.nglVertexAttribI4ivEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI1uEXT(int index, IntBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 1);
        EXTGpuShader4.nglVertexAttribI1uivEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI2uEXT(int index, IntBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 2);
        EXTGpuShader4.nglVertexAttribI2uivEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI3uEXT(int index, IntBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 3);
        EXTGpuShader4.nglVertexAttribI3uivEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI4uEXT(int index, IntBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 4);
        EXTGpuShader4.nglVertexAttribI4uivEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI4EXT(int index, ByteBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 4);
        EXTGpuShader4.nglVertexAttribI4bvEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI4EXT(int index, ShortBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 4);
        EXTGpuShader4.nglVertexAttribI4svEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI4uEXT(int index, ByteBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 4);
        EXTGpuShader4.nglVertexAttribI4ubvEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glVertexAttribI4uEXT(int index, ShortBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 4);
        EXTGpuShader4.nglVertexAttribI4usvEXT(index, MemoryUtil.getAddress(v2), function_pointer);
    }
