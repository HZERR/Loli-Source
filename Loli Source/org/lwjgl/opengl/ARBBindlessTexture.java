...
public final class ARBBindlessTexture {
    ...
    public static void glVertexAttribL1ui64ARB(int index, long x2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL1ui64ARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBBindlessTexture.nglVertexAttribL1ui64ARB(index, x2, function_pointer);
    }

    static native void nglVertexAttribL1ui64ARB(int var0, long var1, long var3);

    public static void glVertexAttribL1uARB(int index, LongBuffer v2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribL1ui64vARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 1);
        ARBBindlessTexture.nglVertexAttribL1ui64vARB(index, MemoryUtil.getAddress(v2), function_pointer);
    }
