...
extends ARBProgram {
    ...
    public static void glVertexAttrib3sARB(int index, short x2, short y2, short z) {
        ARBVertexShader.glVertexAttrib3sARB(index, x2, y2, z);
    }

    public static void glVertexAttrib3fARB(int index, float x2, float y2, float z) {
        ARBVertexShader.glVertexAttrib3fARB(index, x2, y2, z);
    }

    public static void glVertexAttrib3dARB(int index, double x2, double y2, double z) {
        ARBVertexShader.glVertexAttrib3dARB(index, x2, y2, z);
    }

    public static void glVertexAttrib4sARB(int index, short x2, short y2, short z, short w2) {
        ARBVertexShader.glVertexAttrib4sARB(index, x2, y2, z, w2);
    }

    public static void glVertexAttrib4fARB(int index, float x2, float y2, float z, float w2) {
        ARBVertexShader.glVertexAttrib4fARB(index, x2, y2, z, w2);
    }

    public static void glVertexAttrib4dARB(int index, double x2, double y2, double z, double w2) {
        ARBVertexShader.glVertexAttrib4dARB(index, x2, y2, z, w2);
    }

    public static void glVertexAttrib4NubARB(int index, byte x2, byte y2, byte z, byte w2) {
        ARBVertexShader.glVertexAttrib4NubARB(index, x2, y2, z, w2);
    }
