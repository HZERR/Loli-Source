...
public final class NVPathRendering {
    ...
    public static boolean glIsPointInFillPathNV(int path, int mask, float x2, float y2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glIsPointInFillPathNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = NVPathRendering.nglIsPointInFillPathNV(path, mask, x2, y2, function_pointer);
        return __result;
    }

    static native boolean nglIsPointInFillPathNV(int var0, int var1, float var2, float var3, long var4);

    public static boolean glIsPointInStrokePathNV(int path, float x2, float y2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glIsPointInStrokePathNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        boolean __result = NVPathRendering.nglIsPointInStrokePathNV(path, x2, y2, function_pointer);
        return __result;
    }
    ...
    public static boolean glPointAlongPathNV(int path, int startSegment, int numSegments, float distance, FloatBuffer x2, FloatBuffer y2, FloatBuffer tangentX, FloatBuffer tangentY) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPointAlongPathNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        if (x2 != null) {
            BufferChecks.checkBuffer(x2, 1);
        }
        if (y2 != null) {
            BufferChecks.checkBuffer(y2, 1);
        }
        if (tangentX != null) {
        ...
        boolean __result = NVPathRendering.nglPointAlongPathNV(path, startSegment, numSegments, distance, MemoryUtil.getAddressSafe(x2), MemoryUtil.getAddressSafe(y2), MemoryUtil.getAddressSafe(tangentX), MemoryUtil.getAddressSafe(tangentY), function_pointer);
        return __result;
    }
