...
public final class CL11 {
    ...
    public static int clSetMemObjectDestructorCallback(CLMem memobj, CLMemObjectDestructorCallback pfn_notify) {
        ...
        int __result = 0;
        try {
            int n2 = __result = CL11.nclSetMemObjectDestructorCallback(memobj.getPointer(), pfn_notify.getPointer(), user_data, function_pointer);
            return n2;
        }
        finally {
    ...
    public static int clSetEventCallback(CLEvent event, int command_exec_callback_type, CLEventCallback pfn_notify) {
        ...
        int __result = 0;
        try {
            int n2 = __result = CL11.nclSetEventCallback(event.getPointer(), command_exec_callback_type, pfn_notify.getPointer(), user_data, function_pointer);
            return n2;
        }
        finally {
            CallbackUtil.checkCallback(__result, user_data);
