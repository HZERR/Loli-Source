...
public final class CL12 {
    ...
    public static int clCompileProgram(CLProgram program, PointerBuffer device_list, ByteBuffer options, PointerBuffer input_headers, ByteBuffer[] header_include_names, CLCompileProgramCallback pfn_notify) {
        ...
        int __result = 0;
        try {
            int n2 = __result = CL12.nclCompileProgram3(program.getPointer(), device_list == null ? 0 : device_list.remaining(), MemoryUtil.getAddressSafe(device_list), MemoryUtil.getAddress(options), header_include_names.length, MemoryUtil.getAddress(input_headers), header_include_names, pfn_notify == null ? 0L : pfn_notify.getPointer(), user_data, function_pointer);
            return n2;
        }
        finally {
            CallbackUtil.checkCallback(__result, user_data);
    ...
    public static int clSetPrintfCallback(CLContext context, CLPrintfCallback pfn_notify) {
        ...
        int __result = 0;
        try {
            int n2 = __result = CL12.nclSetPrintfCallback(context.getPointer(), pfn_notify.getPointer(), user_data, function_pointer);
            return n2;
        }
        finally {
