...
public class Frame<V extends Value> {
    ...
    public void execute(AbstractInsnNode insn, Interpreter<V> interpreter) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 58: {
                ...
                int var2 = ((VarInsnNode)insn).var;
                this.setLocal(var2, value1);
                if (value1.getSize() == 2) {
                    this.setLocal(var2 + 1, interpreter.newValue(null));
                }
                if (var2 <= 0 || (local = this.getLocal(var2 - 1)) == null || local.getSize() != 2) return;
                this.setLocal(var2 - 1, interpreter.newValue(null));
                return;
            }
            case 79: 
            ...
            case 132: {
                ...
                this.setLocal(var2, interpreter.unaryOperation(insn, this.getLocal(var2)));
                return;
            }
            case 133: 
            case 134: 
    ...
    public String toString() {
        ...
        for (i2 = 0; i2 < this.getLocals(); ++i2) {
            b2.append(this.getLocal(i2));
        }
        b2.append(' ');
        for (i2 = 0; i2 < this.getStackSize(); ++i2) {
            b2.append(this.getStack(i2).toString());
        }
        return b2.toString();
    }
}
