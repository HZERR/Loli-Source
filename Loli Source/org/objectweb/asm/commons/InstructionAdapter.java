...
extends MethodAdapter {
    ...
    public void visitTypeInsn(int opcode, String type) {
        Type t2 = Type.getObjectType(type);
        switch (opcode) {
            case 187: {
                this.anew(t2);
                break;
    ...
    public void visitLdcInsn(Object cst) {
        if (cst instanceof Integer) {
            ...
            this.mtconst((MethodType)cst);
        } else if (cst instanceof MethodHandle) {
            this.mhconst((MethodHandle)cst);
        } else {
            throw new IllegalArgumentException();
        }
    }
    ...
    public void mtconst(MethodType mtype) {
        this.mv.visitLdcInsn(mtype);
    }

    public void mhconst(MethodHandle mhandle) {
        this.mv.visitLdcInsn(mhandle);
    }

    public void load(int var2, Type type) {
        this.mv.visitVarInsn(type.getOpcode(21), var2);
    }
    ...
    public void store(int var2, Type type) {
        this.mv.visitVarInsn(type.getOpcode(54), var2);
    }
    ...
    public void iinc(int var2, int increment) {
    ...
    public void ret(int var2) {
        this.mv.visitVarInsn(169, var2);
    }
    ...
    public void areturn(Type t2) {
        this.mv.visitInsn(t2.getOpcode(172));
    }
    ...
    public void invokedynamic(String name, String desc, MethodHandle bsm, Object[] bsmArgs) {
