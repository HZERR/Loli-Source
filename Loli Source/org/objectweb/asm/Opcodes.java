...
public interface Opcodes {
    ...
    public static final int MH_GETFIELD = 1;
    public static final int MH_GETSTATIC = 2;
    public static final int MH_PUTFIELD = 3;
    public static final int MH_PUTSTATIC = 4;
    public static final int MH_INVOKEVIRTUAL = 5;
    public static final int MH_INVOKESTATIC = 6;
    public static final int MH_INVOKESPECIAL = 7;
    public static final int MH_NEWINVOKESPECIAL = 8;
    public static final int MH_INVOKEINTERFACE = 9;
