...
TransitionAwareUI {
    ...
    protected void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__installComponents(JMenuItem jMenuItem) {
        super.installComponents(jMenuItem);
    }

    @Override
    protected void installComponents(JMenuItem jMenuItem) {
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__installComponents(jMenuItem);
        for (LafWidget lafWidget : this.lafWidgets) {
            lafWidget.installComponents();
        }
    }

    public void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__installUI(JComponent jComponent) {
    ...
    public void installUI(JComponent jComponent) {
        ...
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__installUI(jComponent);
        for (LafWidget lafWidget : this.lafWidgets) {
            lafWidget.installUI();
        }
    }

    public void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__uninstallUI(JComponent jComponent) {
        super.uninstallUI(jComponent);
    }

    @Override
    public void uninstallUI(JComponent jComponent) {
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__uninstallUI(jComponent);
        for (LafWidget lafWidget : this.lafWidgets) {
    ...
    protected void installListeners() {
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__installListeners();
        for (LafWidget lafWidget : this.lafWidgets) {
    ...
    protected void installDefaults() {
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__installDefaults();
        for (LafWidget lafWidget : this.lafWidgets) {
            lafWidget.installDefaults();
        }
    }

    protected void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__uninstallComponents(JMenuItem jMenuItem) {
        super.uninstallComponents(jMenuItem);
    }

    @Override
    protected void uninstallComponents(JMenuItem jMenuItem) {
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__uninstallComponents(jMenuItem);
        for (LafWidget lafWidget : this.lafWidgets) {
    ...
    protected void uninstallListeners() {
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__uninstallListeners();
        for (LafWidget lafWidget : this.lafWidgets) {
            lafWidget.uninstallListeners();
        }
    }

    protected void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__uninstallDefaults() {
        super.uninstallDefaults();
    }

    @Override
    protected void uninstallDefaults() {
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__uninstallDefaults();
        for (LafWidget lafWidget : this.lafWidgets) {
            lafWidget.uninstallDefaults();
        }
    }

    public void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__update(Graphics graphics, JComponent jComponent) {
    ...
    public void update(Graphics graphics, JComponent jComponent) {
        ...
        this.__org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__update(graphics2D, jComponent);
        graphics2D.dispose();
    }
    ...
    protected void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__installListeners() {
    ...
    protected void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__uninstallListeners() {
    ...
    protected void __org__pushingpixels__substance__internal__ui__SubstanceRadioButtonMenuItemUI__installDefaults() {
