...
public class Quaqua15ColorPicker
extends AbstractColorChooserPanel {
        ...
        if (this.pickerFrame == null) {
            ...
            this.pickerFrame.addMouseListener(new MouseAdapter(){
                ...
                public void mousePressed(MouseEvent evt) {
                    Quaqua15ColorPicker.this.pickFinish();
                }

                @Override
                public void mouseExited(MouseEvent evt) {
                    Quaqua15ColorPicker.this.updatePicker();
                }
            });
            ...
            this.pickerFrame.addKeyListener(new KeyAdapter(){
                ...
                public void keyPressed(KeyEvent e2) {
                    switch (e2.getKeyCode()) {
                        case 27: {
                            Quaqua15ColorPicker.this.pickCancel();
                            break;
                        }
                        case 10: {
                            Quaqua15ColorPicker.this.pickFinish();
    ...
    private void initComponents() {
        ...
        this.pickerButton.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Quaqua15ColorPicker.this.pickBegin(evt);
            }
        });
    ...
    protected void buildChooser() {
        ...
        this.pickerButton.setIcon(new TransitionAwareIcon(this.pickerButton, new TransitionAwareIcon.Delegate(){
            ...
            public Icon getColorSchemeIcon(SubstanceColorScheme scheme) {
                return new IconUIResource(SubstanceImageCreator.getSearchIcon(15, scheme, Quaqua15ColorPicker.this.pickerButton.getComponentOrientation().isLeftToRight()));
            }
