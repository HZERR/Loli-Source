...
UIResource {
    ...
    private Icon getIconToPaint() {
        ...
        if (iconBase == null) {
            iconBase = new ImageIcon(SubstanceImageCreator.getCheckBox(this.menuItem, fillPainter, borderPainter, checkMarkSize, currState, baseFillColorScheme, baseMarkColorScheme, baseBorderColorScheme, visibility, isCheckMarkFadingOut));
        ...
        for (Map.Entry<ComponentState, StateTransitionTracker.StateContributionInfo> activeEntry : activeStates.entrySet()) {
            ...
            if (iconLayer == null) {
                iconLayer = new ImageIcon(SubstanceImageCreator.getCheckBox(this.menuItem, fillPainter, borderPainter, checkMarkSize, currState, fillColorScheme, markColorScheme, borderColorScheme, visibility, isCheckMarkFadingOut));
