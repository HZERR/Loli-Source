...
extends iIO0LaND {
    ...
    public i0iOLANd(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, long l2, long l3, long l4, long l5, long l6) {
    ...
    public boolean lO110l1LANd() {
        List list = l1IlliI0lANd.I1O1I1LaNd(this.OOOIilanD());
        if (list.isEmpty()) {
            Iterator iterator = this.lli0OiIlAND().length() < 2 ? null : this.lli0OiIlAND().substring(0, 2);
            list = l1IlliI0lANd.I1O1I1LaNd(iterator, false);
        }
        for (l01l111lAnD l01l111lAnD2 : list) {
            if (!this.OOOIilanD().equals(l01l111lAnD2.OOOIilanD()) || !this.lli0OiIlAND().equals(l01l111lAnD2.lli0OiIlAND())) continue;
