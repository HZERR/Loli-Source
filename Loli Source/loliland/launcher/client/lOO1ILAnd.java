...
final class lOO1ILAnd
extends ll1O0iiland {
    private final Supplier I1O1I1LaNd = lii1IO0LaNd.I1O1I1LaNd(lOO1ILAnd::li0iOILAND);
    ...
    private static O11i1I1lAnd li0iOILAND() {
        ...
        if (iOService != null) {
            ...
            if ((arrby = iOService.getByteArrayProperty("board-id")) != null) {
                string2 = Native.toString(arrby, StandardCharsets.UTF_8);
            }
            if (iiIIIlO1lANd.I1O1I1LaNd(string2) && (arrby = iOService.getByteArrayProperty("model-number")) != null) {
                string2 = Native.toString(arrby, StandardCharsets.UTF_8);
            }
            if ((arrby = iOService.getByteArrayProperty("version")) != null) {
                string3 = Native.toString(arrby, StandardCharsets.UTF_8);
            }
            if ((arrby = iOService.getByteArrayProperty("mlb-serial-number")) != null) {
