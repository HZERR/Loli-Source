...
import loliland.launcher.client.iilOi1LanD;
import loliland.launcher.client.lOilLanD;
import loliland.launcher.client.lii1IO0LaNd;
import loliland.launcher.client.llO1land;
import loliland.launcher.client.lllilIiiLANd;

public class O0Ol0IlAnD
extends O1I01lLANd {
    ...
    public O0Ol0IlAnD(int n2, String[] arrstring) {
        super(n2);
        this.l1i00lLAnD();
    ...
    public String O1il1llOLANd() {
        return iilOi1LanD.I1O1I1LaNd(this.I1O1I1LaNd());
    }
    ...
    public long iOl10IlLAnd() {
        return iilOi1LanD.OOOIilanD(this.I1O1I1LaNd());
    }
    ...
    public List liOIOOLANd() {
        List list;
        ArrayList<llO1land> arrayList = new ArrayList<llO1land>();
        String string = "ps -aHwwxo tid,state,etime,time,nivcsw,nvcsw,majflt,minflt,pri,args";
        ...
        for (String string2 : list) {
            String[] arrstring = lOilLanD.OOOIilanD.split(string2.trim(), 10);
            if (arrstring.length != 10) continue;
            arrayList.add(new llO1land(this.I1O1I1LaNd(), arrstring));
        }
        return arrayList;
    }
    ...
    public boolean l0IO0LAnd() {
        String[] arrstring;
        String string = "ps -awwxo state,pid,ppid,user,uid,group,gid,pri,vsz,rss,etime,cputime,comm,majflt,minflt,args -p " + this.I1O1I1LaNd();
        List list = Iill1lanD.I1O1I1LaNd(string);
        if (list.size() > 1 && (arrstring = lOilLanD.OOOIilanD.split(((String)list.get(1)).trim(), 16)).length == 16) {
            this.l1i00lLAnD();
    ...
    private boolean I1O1I1LaNd(String[] arrstring) {
        ...
        this.IO11O0LANd = lOilLanD.OOOIilanD(arrstring[8], 0L) * 1024L;
        this.l11lLANd = lOilLanD.OOOIilanD(arrstring[9], 0L) * 1024L;
        long l3 = lOilLanD.lli0OiIlAND(arrstring[10], 0L);
        this.iIiO00OLaNd = l3 < 1L ? 1L : l3;
        this.iOIl0LAnD = l2 - this.iIiO00OLaNd;
        this.l0iIlIO1laNd = lOilLanD.lli0OiIlAND(arrstring[11], 0L);
        this.lO110l1LANd = 0L;
        this.lI00OlAND = arrstring[12];
        this.OOOIilanD = this.lI00OlAND.substring(this.lI00OlAND.lastIndexOf(47) + 1);
        this.lI00ilAND = lOilLanD.OOOIilanD(arrstring[13], 0L);
        ...
        this.lli0OiIlAND = arrstring[17];
        return true;
    }

    private void l1i00lLAnD() {
        List list = Iill1lanD.I1O1I1LaNd("ps -axHo tid -p " + this.I1O1I1LaNd());
        if (!list.isEmpty()) {
            this.lli011lLANd = list.size() - 1;
        }
        this.lli011lLANd = 1;
    }
}
