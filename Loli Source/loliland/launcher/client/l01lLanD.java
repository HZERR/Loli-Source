...
final class l01lLanD
extends ilI1l1IOLanD {
    private static final String I1O1I1LaNd = "lshal";
    private static final String OOOIilanD = "audio810";

    l01lLanD(String string, String string2, String string3) {
    ...
    public static List lli0OiIlAND() {
        ...
        for (Object object : Iill1lanD.I1O1I1LaNd(I1O1I1LaNd)) {
            ...
            if (((String)object).contains("info.solaris.driver =") && OOOIilanD.equals(lOilLanD.li0iOILAND((String)object))) {
        ...
        for (String string2 : arrayList) {
            arrayList2.add(new l01lLanD((String)hashMap2.get(string2) + " " + OOOIilanD, (String)hashMap.get(string2) + " " + (String)hashMap2.get(string2), (String)hashMap2.get(string2)));
        }
        return arrayList2;
    }
}
