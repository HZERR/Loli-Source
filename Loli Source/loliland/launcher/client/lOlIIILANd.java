...
extends iIO0LaND {
    ...
    public lOlIIILANd(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, long l2, long l3, long l4, long l5, long l6) {
    ...
    public boolean lO110l1LANd() {
        for (l01l111lAnD l01l111lAnD2 : lOliOILaND.I1O1I1LaNd(this.I1O1I1LaNd())) {
