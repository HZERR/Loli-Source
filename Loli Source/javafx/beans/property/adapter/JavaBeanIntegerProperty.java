...
implements JavaBeanProperty<Number> {
    ...
    JavaBeanIntegerProperty(PropertyDescriptor propertyDescriptor, Object object) {
    ...
    public int get() {
        return AccessController.doPrivileged(() -> {
            try {
                return ((Number)MethodUtil.invoke(this.descriptor.getGetter(), this.getBean(), null)).intValue();
            }
    ...
    public void set(int n2) {
        ...
        AccessController.doPrivileged(() -> {
            try {
                MethodUtil.invoke(this.descriptor.getSetter(), this.getBean(), new Object[]{n2});
    ...
    public void bind(ObservableValue<? extends Number> observableValue) {
        ...
        if (!observableValue.equals(this.observable)) {
            this.unbind();
            this.set(observableValue.getValue().intValue());
