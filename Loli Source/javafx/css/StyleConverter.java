...
public class StyleConverter<F, T> {
    ...
    public static <E extends Enum<E>> StyleConverter<String, ? extends Enum<?>> getEnumConverter(Class<E> class_) {
        EnumConverter<E> enumConverter = new EnumConverter<E>(class_);
